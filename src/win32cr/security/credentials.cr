...
module Win32cr::Security::Credentials
  ...
  def sCardListReadersA(hContext : LibC::UIntPtrT, mszGroups : Win32cr::Foundation::PSTR, mszReaders : UInt8*, pcchReaders : UInt32*) : Int32
    {% if !flag?(:docs) %}
    C.SCardListReadersA(hContext, mszGroups, mszReaders, pcchReaders)
    {% end %}
  end

  def sCardListReadersW(hContext : LibC::UIntPtrT, mszGroups : Win32cr::Foundation::PWSTR, mszReaders : UInt16*, pcchReaders : UInt32*) : Int32
    {% if !flag?(:docs) %}
    C.SCardListReadersW(hContext, mszGroups, mszReaders, pcchReaders)
    {% end %}
  end

  def sCardListCardsA(hContext : LibC::UIntPtrT, pbAtr : UInt8*, rgquidInterfaces : LibC::GUID*, cguidInterfaceCount : UInt32, mszCards : UInt8*, pcchCards : UInt32*) : Int32
    {% if !flag?(:docs) %}
    C.SCardListCardsA(hContext, pbAtr, rgquidInterfaces, cguidInterfaceCount, mszCards, pcchCards)
    {% end %}
  end

  def sCardListCardsW(hContext : LibC::UIntPtrT, pbAtr : UInt8*, rgquidInterfaces : LibC::GUID*, cguidInterfaceCount : UInt32, mszCards : UInt16*, pcchCards : UInt32*) : Int32
    {% if !flag?(:docs) %}
  ...
  def sCardStatusA(hCard : LibC::UIntPtrT, mszReaderNames : UInt8*, pcchReaderLen : UInt32*, pdwState : UInt32*, pdwProtocol : UInt32*, pbAtr : UInt8*, pcbAtrLen : UInt32*) : Int32
    {% if !flag?(:docs) %}
    C.SCardStatusA(hCard, mszReaderNames, pcchReaderLen, pdwState, pdwProtocol, pbAtr, pcbAtrLen)
    {% end %}
  end

  def sCardStatusW(hCard : LibC::UIntPtrT, mszReaderNames : UInt16*, pcchReaderLen : UInt32*, pdwState : UInt32*, pdwProtocol : UInt32*, pbAtr : UInt8*, pcbAtrLen : UInt32*) : Int32
    {% if !flag?(:docs) %}
  ...
  def sCardGetReaderDeviceInstanceIdA(hContext : LibC::UIntPtrT, szReaderName : Win32cr::Foundation::PSTR, szDeviceInstanceId : UInt8*, pcchDeviceInstanceId : UInt32*) : Int32
    {% if !flag?(:docs) %}
    C.SCardGetReaderDeviceInstanceIdA(hContext, szReaderName, szDeviceInstanceId, pcchDeviceInstanceId)
    {% end %}
  end

  def sCardGetReaderDeviceInstanceIdW(hContext : LibC::UIntPtrT, szReaderName : Win32cr::Foundation::PWSTR, szDeviceInstanceId : UInt16*, pcchDeviceInstanceId : UInt32*) : Int32
    {% if !flag?(:docs) %}
    C.SCardGetReaderDeviceInstanceIdW(hContext, szReaderName, szDeviceInstanceId, pcchDeviceInstanceId)
    {% end %}
  end

  def sCardListReadersWithDeviceInstanceIdA(hContext : LibC::UIntPtrT, szDeviceInstanceId : Win32cr::Foundation::PSTR, mszReaders : UInt8*, pcchReaders : UInt32*) : Int32
    {% if !flag?(:docs) %}
    C.SCardListReadersWithDeviceInstanceIdA(hContext, szDeviceInstanceId, mszReaders, pcchReaders)
    {% end %}
  end

  def sCardListReadersWithDeviceInstanceIdW(hContext : LibC::UIntPtrT, szDeviceInstanceId : Win32cr::Foundation::PWSTR, mszReaders : UInt16*, pcchReaders : UInt32*) : Int32
    {% if !flag?(:docs) %}
  ...
  lib C
    ...
    # :nodoc:
    fun SCardListReadersA(hContext : LibC::UIntPtrT, mszGroups : Win32cr::Foundation::PSTR, mszReaders : UInt8*, pcchReaders : UInt32*) : Int32

    # :nodoc:
    fun SCardListReadersW(hContext : LibC::UIntPtrT, mszGroups : Win32cr::Foundation::PWSTR, mszReaders : UInt16*, pcchReaders : UInt32*) : Int32

    # :nodoc:
    fun SCardListCardsA(hContext : LibC::UIntPtrT, pbAtr : UInt8*, rgquidInterfaces : LibC::GUID*, cguidInterfaceCount : UInt32, mszCards : UInt8*, pcchCards : UInt32*) : Int32

    # :nodoc:
    fun SCardListCardsW(hContext : LibC::UIntPtrT, pbAtr : UInt8*, rgquidInterfaces : LibC::GUID*, cguidInterfaceCount : UInt32, mszCards : UInt16*, pcchCards : UInt32*) : Int32
    ...
    # :nodoc:
    fun SCardStatusA(hCard : LibC::UIntPtrT, mszReaderNames : UInt8*, pcchReaderLen : UInt32*, pdwState : UInt32*, pdwProtocol : UInt32*, pbAtr : UInt8*, pcbAtrLen : UInt32*) : Int32

    # :nodoc:
    fun SCardStatusW(hCard : LibC::UIntPtrT, mszReaderNames : UInt16*, pcchReaderLen : UInt32*, pdwState : UInt32*, pdwProtocol : UInt32*, pbAtr : UInt8*, pcbAtrLen : UInt32*) : Int32
    ...
    # :nodoc:
    fun SCardGetReaderDeviceInstanceIdA(hContext : LibC::UIntPtrT, szReaderName : Win32cr::Foundation::PSTR, szDeviceInstanceId : UInt8*, pcchDeviceInstanceId : UInt32*) : Int32

    # :nodoc:
    fun SCardGetReaderDeviceInstanceIdW(hContext : LibC::UIntPtrT, szReaderName : Win32cr::Foundation::PWSTR, szDeviceInstanceId : UInt16*, pcchDeviceInstanceId : UInt32*) : Int32

    # :nodoc:
    fun SCardListReadersWithDeviceInstanceIdA(hContext : LibC::UIntPtrT, szDeviceInstanceId : Win32cr::Foundation::PSTR, mszReaders : UInt8*, pcchReaders : UInt32*) : Int32

    # :nodoc:
    fun SCardListReadersWithDeviceInstanceIdW(hContext : LibC::UIntPtrT, szDeviceInstanceId : Win32cr::Foundation::PWSTR, mszReaders : UInt16*, pcchReaders : UInt32*) : Int32
