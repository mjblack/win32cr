...
module Win32cr::Data::Xml::XmlLite
  ...
  enum XmlConformanceLevel
    ...
    XmlConformanceLevel_Last_ = 2_i32
  end
  enum DtdProcessing
    DtdProcessing_Prohibit = 0_i32
    DtdProcessing_Parse = 1_i32
    DtdProcessing_Last_ = 1_i32
  end
  enum XmlReadState
