...
module Win32cr::NetworkManagement::NetManagement
  ...
  AE_SRVSTATUS_ = 0_u32
  AE_SESSLOGON_ = 1_u32
  AE_SESSLOGOFF_ = 2_u32
  AE_SESSPWERR_ = 3_u32
  AE_CONNSTART_ = 4_u32
  AE_CONNSTOP_ = 5_u32
  AE_CONNREJ_ = 6_u32
  AE_RESACCESS_ = 7_u32
  AE_RESACCESSREJ_ = 8_u32
  AE_CLOSEFILE_ = 9_u32
  AE_SERVICESTAT_ = 11_u32
  AE_ACLMOD_ = 12_u32
  AE_UASMOD_ = 13_u32
  AE_NETLOGON_ = 14_u32
  AE_NETLOGOFF_ = 15_u32
  ...
  enum NET_REQUEST_PROVISION_OPTIONS : UInt32
    NETSETUP_PROVISION_ONLINE_CALLER = 1073741824_u32
  end
  @[Flags]
  enum NET_JOIN_DOMAIN_JOIN_OPTIONS : UInt32
    NETSETUP_JOIN_DOMAIN = 1_u32
    NETSETUP_ACCT_CREATE = 2_u32
    NETSETUP_WIN9X_UPGRADE = 16_u32
    NETSETUP_DOMAIN_JOIN_IF_JOINED = 32_u32
    NETSETUP_JOIN_UNSECURE = 64_u32
    NETSETUP_MACHINE_PWD_PASSED = 128_u32
    NETSETUP_DEFER_SPN_SET = 256_u32
    NETSETUP_JOIN_DC_ACCOUNT = 512_u32
    NETSETUP_JOIN_WITH_NEW_NAME = 1024_u32
    NETSETUP_JOIN_READONLY = 2048_u32
    NETSETUP_AMBIGUOUS_DC = 4096_u32
    NETSETUP_NO_NETLOGON_CACHE = 8192_u32
    NETSETUP_DONT_CONTROL_SERVICES = 16384_u32
    NETSETUP_SET_MACHINE_NAME = 32768_u32
    NETSETUP_FORCE_SPN_SET = 65536_u32
    NETSETUP_NO_ACCT_REUSE = 131072_u32
    NETSETUP_IGNORE_UNSUPPORTED_FLAGS = 268435456_u32
  end
  enum NET_REMOTE_COMPUTER_SUPPORTS_OPTIONS
    SUPPORTS_REMOTE_ADMIN_PROTOCOL = 2_i32
    SUPPORTS_RPC = 4_i32
    SUPPORTS_SAM_PROTOCOL = 8_i32
    SUPPORTS_UNICODE = 16_i32
    SUPPORTS_LOCAL = 32_i32
  end
  enum FORCE_LEVEL_FLAGS : UInt32
    USE_NOFORCE = 0_u32
    USE_FORCE = 1_u32
    USE_LOTS_OF_FORCE = 2_u32
  end
  @[Flags]
  enum NET_SERVER_TYPE : UInt32
    SV_TYPE_WORKSTATION = 1_u32
    SV_TYPE_SERVER = 2_u32
    SV_TYPE_SQLSERVER = 4_u32
    SV_TYPE_DOMAIN_CTRL = 8_u32
    SV_TYPE_DOMAIN_BAKCTRL = 16_u32
    SV_TYPE_TIME_SOURCE = 32_u32
    SV_TYPE_AFP = 64_u32
    SV_TYPE_NOVELL = 128_u32
    SV_TYPE_DOMAIN_MEMBER = 256_u32
    SV_TYPE_PRINTQ_SERVER = 512_u32
    SV_TYPE_DIALIN_SERVER = 1024_u32
    SV_TYPE_XENIX_SERVER = 2048_u32
    SV_TYPE_SERVER_UNIX = 2048_u32
    SV_TYPE_NT = 4096_u32
    SV_TYPE_WFW = 8192_u32
    SV_TYPE_SERVER_MFPN = 16384_u32
    SV_TYPE_SERVER_NT = 32768_u32
    SV_TYPE_POTENTIAL_BROWSER = 65536_u32
    SV_TYPE_BACKUP_BROWSER = 131072_u32
    SV_TYPE_MASTER_BROWSER = 262144_u32
    SV_TYPE_DOMAIN_MASTER = 524288_u32
    SV_TYPE_SERVER_OSF = 1048576_u32
    SV_TYPE_SERVER_VMS = 2097152_u32
    SV_TYPE_WINDOWS = 4194304_u32
    SV_TYPE_DFS = 8388608_u32
    SV_TYPE_CLUSTER_NT = 16777216_u32
    SV_TYPE_TERMINALSERVER = 33554432_u32
    SV_TYPE_CLUSTER_VS_NT = 67108864_u32
    SV_TYPE_DCE = 268435456_u32
    SV_TYPE_ALTERNATE_XPORT = 536870912_u32
    SV_TYPE_LOCAL_LIST_ONLY = 1073741824_u32
    SV_TYPE_DOMAIN_ENUM = 2147483648_u32
    SV_TYPE_ALL = 4294967295_u32
  end
  @[Flags]
  enum NET_USER_ENUM_FILTER_FLAGS : UInt32
    FILTER_TEMP_DUPLICATE_ACCOUNT = 1_u32
    FILTER_NORMAL_ACCOUNT = 2_u32
    FILTER_INTERDOMAIN_TRUST_ACCOUNT = 8_u32
    FILTER_WORKSTATION_TRUST_ACCOUNT = 16_u32
    FILTER_SERVER_TRUST_ACCOUNT = 32_u32
  end
  @[Flags]
  enum NETSETUP_PROVISION : UInt32
    NETSETUP_PROVISION_DOWNLEVEL_PRIV_SUPPORT = 1_u32
    NETSETUP_PROVISION_REUSE_ACCOUNT = 2_u32
    NETSETUP_PROVISION_USE_DEFAULT_PASSWORD = 4_u32
    NETSETUP_PROVISION_SKIP_ACCOUNT_SEARCH = 8_u32
    NETSETUP_PROVISION_ROOT_CA_CERTS = 16_u32
  end
  @[Flags]
  enum USER_ACCOUNT_FLAGS : UInt32
    UF_SCRIPT = 1_u32
    UF_ACCOUNTDISABLE = 2_u32
    UF_HOMEDIR_REQUIRED = 8_u32
    UF_PASSWD_NOTREQD = 32_u32
    UF_PASSWD_CANT_CHANGE = 64_u32
    UF_LOCKOUT = 16_u32
    UF_DONT_EXPIRE_PASSWD = 65536_u32
    UF_ENCRYPTED_TEXT_PASSWORD_ALLOWED = 128_u32
    UF_NOT_DELEGATED = 1048576_u32
    UF_SMARTCARD_REQUIRED = 262144_u32
    UF_USE_DES_KEY_ONLY = 2097152_u32
    UF_DONT_REQUIRE_PREAUTH = 4194304_u32
    UF_TRUSTED_FOR_DELEGATION = 524288_u32
    UF_PASSWORD_EXPIRED = 8388608_u32
    UF_TRUSTED_TO_AUTHENTICATE_FOR_DELEGATION = 16777216_u32
  end
  @[Flags]
  enum AF_OP : UInt32
    AF_OP_PRINT = 1_u32
    AF_OP_COMM = 2_u32
    AF_OP_SERVER = 4_u32
    AF_OP_ACCOUNTS = 8_u32
  end
  enum SERVER_INFO_SECURITY : UInt32
    SV_SHARESECURITY = 0_u32
    SV_USERSECURITY = 1_u32
  end
  enum USER_PRIV : UInt32
    USER_PRIV_GUEST = 0_u32
    USER_PRIV_USER = 1_u32
    USER_PRIV_ADMIN = 2_u32
  end
  enum USE_INFO_ASG_TYPE : UInt32
    USE_WILDCARD = 4294967295_u32
    USE_DISKDEV = 0_u32
    USE_SPOOLDEV = 1_u32
    USE_IPC = 3_u32
  end
  ...
  enum USER_MODALS_ROLES : UInt32
    UAS_ROLE_STANDALONE = 0_u32
    UAS_ROLE_MEMBER = 1_u32
    UAS_ROLE_BACKUP = 2_u32
    UAS_ROLE_PRIMARY = 3_u32
  end
  enum NET_VALIDATE_PASSWORD_TYPE
    NetValidateAuthentication = 1_i32
    NetValidatePasswordChange = 2_i32
    NetValidatePasswordReset = 3_i32
  end
  enum MSA_INFO_LEVEL
    MsaInfoLevel0 = 0_i32
    MsaInfoLevelMax = 1_i32
  end
  enum MSA_INFO_STATE
    MsaInfoNotExist = 1_i32
    MsaInfoNotService = 2_i32
    MsaInfoCannotInstall = 3_i32
    MsaInfoCanInstall = 4_i32
    MsaInfoInstalled = 5_i32
  end
  enum TRANSPORT_TYPE
    UseTransportType_None = 0_i32
    UseTransportType_Wsk = 1_i32
    UseTransportType_Quic = 2_i32
  end
  enum NETSETUP_NAME_TYPE
    NetSetupUnknown = 0_i32
    NetSetupMachine = 1_i32
    NetSetupWorkgroup = 2_i32
    NetSetupDomain = 3_i32
    NetSetupNonExistentDomain = 4_i32
    NetSetupDnsMachine = 5_i32
  end
  enum DSREG_JOIN_TYPE
    DSREG_UNKNOWN_JOIN = 0_i32
    DSREG_DEVICE_JOIN = 1_i32
    DSREG_WORKPLACE_JOIN = 2_i32
  end
  enum NET_COMPUTER_NAME_TYPE
    NetPrimaryComputerName = 0_i32
    NetAlternateComputerNames = 1_i32
    NetAllComputerNames = 2_i32
    NetComputerNameTypeMax = 3_i32
  end
  enum NETSETUP_JOIN_STATUS
    NetSetupUnknownStatus = 0_i32
    NetSetupUnjoined = 1_i32
    NetSetupWorkgroupName = 2_i32
    NetSetupDomainName = 3_i32
  end
  enum OBO_TOKEN_TYPE
    OBO_USER = 1_i32
    OBO_COMPONENT = 2_i32
  ...
  enum COMPONENT_CHARACTERISTICS
    NCF_VIRTUAL = 1_i32
    NCF_SOFTWARE_ENUMERATED = 2_i32
    NCF_PHYSICAL = 4_i32
    NCF_HIDDEN = 8_i32
    NCF_NO_SERVICE = 16_i32
    NCF_NOT_USER_REMOVABLE = 32_i32
    NCF_MULTIPORT_INSTANCED_ADAPTER = 64_i32
    NCF_HAS_UI = 128_i32
    NCF_SINGLE_INSTANCE = 256_i32
    NCF_FILTER = 1024_i32
    NCF_DONTEXPOSELOWER = 4096_i32
    NCF_HIDE_BINDING = 8192_i32
    NCF_NDIS_PROTOCOL = 16384_i32
    NCF_FIXED_BINDING = 131072_i32
    NCF_LW_FILTER = 262144_i32
  end
  enum NCRP_FLAGS
    NCRP_QUERY_PROPERTY_UI = 1_i32
    NCRP_SHOW_PROPERTY_UI = 2_i32
  end
  ...
  enum NCPNP_RECONFIG_LAYER
    NCRL_NDIS = 1_i32
    NCRL_TDI = 2_i32
  end
  enum NETWORK_INSTALL_TIME
    NSF_PRIMARYINSTALL = 1_i32
    NSF_POSTSYSINSTALL = 2_i32
  end
  enum NETWORK_UPGRADE_TYPE
    NSF_WIN16_UPGRADE = 16_i32
    NSF_WIN95_UPGRADE = 32_i32
    NSF_WINNT_WKS_UPGRADE = 64_i32
    NSF_WINNT_SVR_UPGRADE = 128_i32
    NSF_WINNT_SBS_UPGRADE = 256_i32
    NSF_COMPONENT_UPDATE = 512_i32
  end
  enum DEFAULT_PAGES
    DPP_ADVANCED = 1_i32
  end
  enum BIND_FLAGS1
    ...
    NCN_ENABLE = 16_i32
    NCN_DISABLE = 32_i32
    NCN_BINDING_PATH = 256_i32
    NCN_PROPERTYCHANGE = 512_i32
    NCN_NET = 65536_i32
    NCN_NETTRANS = 131072_i32
    NCN_NETCLIENT = 262144_i32
    NCN_NETSERVICE = 524288_i32
  end
  enum RASCON_IPUI_FLAGS
    RCUIF_VPN = 1_i32
    RCUIF_DEMAND_DIAL = 2_i32
    RCUIF_NOT_ADMIN = 4_i32
    RCUIF_USE_IPv4_STATICADDRESS = 8_i32
    RCUIF_USE_IPv4_NAME_SERVERS = 16_i32
    RCUIF_USE_IPv4_REMOTE_GATEWAY = 32_i32
    RCUIF_USE_IPv4_EXPLICIT_METRIC = 64_i32
    RCUIF_USE_HEADER_COMPRESSION = 128_i32
    RCUIF_USE_DISABLE_REGISTER_DNS = 256_i32
    RCUIF_USE_PRIVATE_DNS_SUFFIX = 512_i32
    RCUIF_ENABLE_NBT = 1024_i32
    RCUIF_USE_IPv6_STATICADDRESS = 2048_i32
    RCUIF_USE_IPv6_NAME_SERVERS = 4096_i32
    RCUIF_USE_IPv6_REMOTE_GATEWAY = 8192_i32
    RCUIF_USE_IPv6_EXPLICIT_METRIC = 16384_i32
    RCUIF_DISABLE_CLASS_BASED_ROUTE = 32768_i32
  end
  ...
  record IEnumNetCfgBindingInterfaceVtbl,
    ...
    next__ : Proc(IEnumNetCfgBindingInterface*, UInt32, Void**, UInt32*, Win32cr::Foundation::HRESULT),
    skip : Proc(IEnumNetCfgBindingInterface*, UInt32, Win32cr::Foundation::HRESULT),
    reset : Proc(IEnumNetCfgBindingInterface*, Win32cr::Foundation::HRESULT),
    clone : Proc(IEnumNetCfgBindingInterface*, Void**, Win32cr::Foundation::HRESULT)
  ...
  record IEnumNetCfgBindingInterface, lpVtbl : IEnumNetCfgBindingInterfaceVtbl* do
    ...
    def next__(this : IEnumNetCfgBindingInterface*, celt : UInt32, rgelt : Void**, pceltFetched : UInt32*) : Win32cr::Foundation::HRESULT
      @lpVtbl.try &.value.next__.call(this, celt, rgelt, pceltFetched)
    end
    def skip(this : IEnumNetCfgBindingInterface*, celt : UInt32) : Win32cr::Foundation::HRESULT
      @lpVtbl.try &.value.skip.call(this, celt)
    end
    def reset(this : IEnumNetCfgBindingInterface*) : Win32cr::Foundation::HRESULT
      @lpVtbl.try &.value.reset.call(this)
    end
    def clone(this : IEnumNetCfgBindingInterface*, ppenum : Void**) : Win32cr::Foundation::HRESULT
  ...
  record IEnumNetCfgBindingPathVtbl,
    ...
    next__ : Proc(IEnumNetCfgBindingPath*, UInt32, Void**, UInt32*, Win32cr::Foundation::HRESULT),
    skip : Proc(IEnumNetCfgBindingPath*, UInt32, Win32cr::Foundation::HRESULT),
    reset : Proc(IEnumNetCfgBindingPath*, Win32cr::Foundation::HRESULT),
    clone : Proc(IEnumNetCfgBindingPath*, Void**, Win32cr::Foundation::HRESULT)
  ...
  record IEnumNetCfgBindingPath, lpVtbl : IEnumNetCfgBindingPathVtbl* do
    ...
    def next__(this : IEnumNetCfgBindingPath*, celt : UInt32, rgelt : Void**, pceltFetched : UInt32*) : Win32cr::Foundation::HRESULT
      @lpVtbl.try &.value.next__.call(this, celt, rgelt, pceltFetched)
    end
    def skip(this : IEnumNetCfgBindingPath*, celt : UInt32) : Win32cr::Foundation::HRESULT
      @lpVtbl.try &.value.skip.call(this, celt)
    end
    def reset(this : IEnumNetCfgBindingPath*) : Win32cr::Foundation::HRESULT
      @lpVtbl.try &.value.reset.call(this)
    end
    def clone(this : IEnumNetCfgBindingPath*, ppenum : Void**) : Win32cr::Foundation::HRESULT
      @lpVtbl.try &.value.clone.call(this, ppenum)
    end
  ...
  record IEnumNetCfgComponentVtbl,
    ...
    next__ : Proc(IEnumNetCfgComponent*, UInt32, Void**, UInt32*, Win32cr::Foundation::HRESULT),
    skip : Proc(IEnumNetCfgComponent*, UInt32, Win32cr::Foundation::HRESULT),
    reset : Proc(IEnumNetCfgComponent*, Win32cr::Foundation::HRESULT),
    clone : Proc(IEnumNetCfgComponent*, Void**, Win32cr::Foundation::HRESULT)
  ...
  record IEnumNetCfgComponent, lpVtbl : IEnumNetCfgComponentVtbl* do
    ...
    def next__(this : IEnumNetCfgComponent*, celt : UInt32, rgelt : Void**, pceltFetched : UInt32*) : Win32cr::Foundation::HRESULT
      @lpVtbl.try &.value.next__.call(this, celt, rgelt, pceltFetched)
    end
    def skip(this : IEnumNetCfgComponent*, celt : UInt32) : Win32cr::Foundation::HRESULT
      @lpVtbl.try &.value.skip.call(this, celt)
    end
    def reset(this : IEnumNetCfgComponent*) : Win32cr::Foundation::HRESULT
      @lpVtbl.try &.value.reset.call(this)
    end
    def clone(this : IEnumNetCfgComponent*, ppenum : Void**) : Win32cr::Foundation::HRESULT
      @lpVtbl.try &.value.clone.call(this, ppenum)
    end
  ...
  record INetCfgVtbl,
    ...
    initialize__ : Proc(INetCfg*, Void*, Win32cr::Foundation::HRESULT),
    uninitialize : Proc(INetCfg*, Win32cr::Foundation::HRESULT),
    apply : Proc(INetCfg*, Win32cr::Foundation::HRESULT),
    cancel : Proc(INetCfg*, Win32cr::Foundation::HRESULT),
    enum_components : Proc(INetCfg*, LibC::GUID*, Void**, Win32cr::Foundation::HRESULT),
    find_component : Proc(INetCfg*, Win32cr::Foundation::PWSTR, Void**, Win32cr::Foundation::HRESULT),
    query_net_cfg_class : Proc(INetCfg*, LibC::GUID*, LibC::GUID*, Void**, Win32cr::Foundation::HRESULT)
  ...
  record INetCfg, lpVtbl : INetCfgVtbl* do
    ...
    def initialize__(this : INetCfg*, pvReserved : Void*) : Win32cr::Foundation::HRESULT
      @lpVtbl.try &.value.initialize__.call(this, pvReserved)
    end
    def uninitialize(this : INetCfg*) : Win32cr::Foundation::HRESULT
      @lpVtbl.try &.value.uninitialize.call(this)
    end
    def apply(this : INetCfg*) : Win32cr::Foundation::HRESULT
      @lpVtbl.try &.value.apply.call(this)
    end
    def cancel(this : INetCfg*) : Win32cr::Foundation::HRESULT
      @lpVtbl.try &.value.cancel.call(this)
    end
    def enum_components(this : INetCfg*, pguidClass : LibC::GUID*, ppenumComponent : Void**) : Win32cr::Foundation::HRESULT
      @lpVtbl.try &.value.enum_components.call(this, pguidClass, ppenumComponent)
    end
    def find_component(this : INetCfg*, pszwInfId : Win32cr::Foundation::PWSTR, pComponent : Void**) : Win32cr::Foundation::HRESULT
      @lpVtbl.try &.value.find_component.call(this, pszwInfId, pComponent)
    end
    def query_net_cfg_class(this : INetCfg*, pguidClass : LibC::GUID*, riid : LibC::GUID*, ppvObject : Void**) : Win32cr::Foundation::HRESULT
      @lpVtbl.try &.value.query_net_cfg_class.call(this, pguidClass, riid, ppvObject)
    end
  ...
  record INetCfgLockVtbl,
    ...
    acquire_write_lock : Proc(INetCfgLock*, UInt32, Win32cr::Foundation::PWSTR, Win32cr::Foundation::PWSTR*, Win32cr::Foundation::HRESULT),
    release_write_lock : Proc(INetCfgLock*, Win32cr::Foundation::HRESULT),
    is_write_locked : Proc(INetCfgLock*, Win32cr::Foundation::PWSTR*, Win32cr::Foundation::HRESULT)
  ...
  record INetCfgLock, lpVtbl : INetCfgLockVtbl* do
    ...
    def acquire_write_lock(this : INetCfgLock*, cmsTimeout : UInt32, pszwClientDescription : Win32cr::Foundation::PWSTR, ppszwClientDescription : Win32cr::Foundation::PWSTR*) : Win32cr::Foundation::HRESULT
      @lpVtbl.try &.value.acquire_write_lock.call(this, cmsTimeout, pszwClientDescription, ppszwClientDescription)
    end
    def release_write_lock(this : INetCfgLock*) : Win32cr::Foundation::HRESULT
      @lpVtbl.try &.value.release_write_lock.call(this)
    end
    def is_write_locked(this : INetCfgLock*, ppszwClientDescription : Win32cr::Foundation::PWSTR*) : Win32cr::Foundation::HRESULT
      @lpVtbl.try &.value.is_write_locked.call(this, ppszwClientDescription)
    end
  ...
  record INetCfgBindingInterfaceVtbl,
    ...
    get_name : Proc(INetCfgBindingInterface*, Win32cr::Foundation::PWSTR*, Win32cr::Foundation::HRESULT),
    get_upper_component : Proc(INetCfgBindingInterface*, Void**, Win32cr::Foundation::HRESULT),
    get_lower_component : Proc(INetCfgBindingInterface*, Void**, Win32cr::Foundation::HRESULT)
  ...
  record INetCfgBindingInterface, lpVtbl : INetCfgBindingInterfaceVtbl* do
    ...
    def get_name(this : INetCfgBindingInterface*, ppszwInterfaceName : Win32cr::Foundation::PWSTR*) : Win32cr::Foundation::HRESULT
      @lpVtbl.try &.value.get_name.call(this, ppszwInterfaceName)
    end
    def get_upper_component(this : INetCfgBindingInterface*, ppnccItem : Void**) : Win32cr::Foundation::HRESULT
      @lpVtbl.try &.value.get_upper_component.call(this, ppnccItem)
    end
    def get_lower_component(this : INetCfgBindingInterface*, ppnccItem : Void**) : Win32cr::Foundation::HRESULT
      @lpVtbl.try &.value.get_lower_component.call(this, ppnccItem)
    end
  ...
  record INetCfgBindingPathVtbl,
    ...
    is_same_path_as : Proc(INetCfgBindingPath*, Void*, Win32cr::Foundation::HRESULT),
    is_sub_path_of : Proc(INetCfgBindingPath*, Void*, Win32cr::Foundation::HRESULT),
    is_enabled : Proc(INetCfgBindingPath*, Win32cr::Foundation::HRESULT),
    enable : Proc(INetCfgBindingPath*, Win32cr::Foundation::BOOL, Win32cr::Foundation::HRESULT),
    get_path_token : Proc(INetCfgBindingPath*, Win32cr::Foundation::PWSTR*, Win32cr::Foundation::HRESULT),
    get_owner : Proc(INetCfgBindingPath*, Void**, Win32cr::Foundation::HRESULT),
    get_depth : Proc(INetCfgBindingPath*, UInt32*, Win32cr::Foundation::HRESULT),
    enum_binding_interfaces : Proc(INetCfgBindingPath*, Void**, Win32cr::Foundation::HRESULT)
  ...
  record INetCfgBindingPath, lpVtbl : INetCfgBindingPathVtbl* do
    ...
    def is_same_path_as(this : INetCfgBindingPath*, pPath : Void*) : Win32cr::Foundation::HRESULT
      @lpVtbl.try &.value.is_same_path_as.call(this, pPath)
    end
    def is_sub_path_of(this : INetCfgBindingPath*, pPath : Void*) : Win32cr::Foundation::HRESULT
      @lpVtbl.try &.value.is_sub_path_of.call(this, pPath)
    end
    def is_enabled(this : INetCfgBindingPath*) : Win32cr::Foundation::HRESULT
      @lpVtbl.try &.value.is_enabled.call(this)
    end
    def enable(this : INetCfgBindingPath*, fEnable : Win32cr::Foundation::BOOL) : Win32cr::Foundation::HRESULT
      @lpVtbl.try &.value.enable.call(this, fEnable)
    end
    def get_path_token(this : INetCfgBindingPath*, ppszwPathToken : Win32cr::Foundation::PWSTR*) : Win32cr::Foundation::HRESULT
      @lpVtbl.try &.value.get_path_token.call(this, ppszwPathToken)
    end
    def get_owner(this : INetCfgBindingPath*, ppComponent : Void**) : Win32cr::Foundation::HRESULT
      @lpVtbl.try &.value.get_owner.call(this, ppComponent)
    end
    def get_depth(this : INetCfgBindingPath*, pcInterfaces : UInt32*) : Win32cr::Foundation::HRESULT
      @lpVtbl.try &.value.get_depth.call(this, pcInterfaces)
    end
    def enum_binding_interfaces(this : INetCfgBindingPath*, ppenumInterface : Void**) : Win32cr::Foundation::HRESULT
      @lpVtbl.try &.value.enum_binding_interfaces.call(this, ppenumInterface)
    end
  ...
  record INetCfgClassVtbl,
    ...
    find_component : Proc(INetCfgClass*, Win32cr::Foundation::PWSTR, Void**, Win32cr::Foundation::HRESULT),
    enum_components : Proc(INetCfgClass*, Void**, Win32cr::Foundation::HRESULT)
  ...
  record INetCfgClass, lpVtbl : INetCfgClassVtbl* do
    ...
    def find_component(this : INetCfgClass*, pszwInfId : Win32cr::Foundation::PWSTR, ppnccItem : Void**) : Win32cr::Foundation::HRESULT
      @lpVtbl.try &.value.find_component.call(this, pszwInfId, ppnccItem)
    end
    def enum_components(this : INetCfgClass*, ppenumComponent : Void**) : Win32cr::Foundation::HRESULT
      @lpVtbl.try &.value.enum_components.call(this, ppenumComponent)
    end
  ...
  record INetCfgClassSetupVtbl,
    ...
    select_and_install : Proc(INetCfgClassSetup*, Win32cr::Foundation::HWND, Win32cr::NetworkManagement::NetManagement::OBO_TOKEN*, Void**, Win32cr::Foundation::HRESULT),
    install : Proc(INetCfgClassSetup*, Win32cr::Foundation::PWSTR, Win32cr::NetworkManagement::NetManagement::OBO_TOKEN*, UInt32, UInt32, Win32cr::Foundation::PWSTR, Win32cr::Foundation::PWSTR, Void**, Win32cr::Foundation::HRESULT),
    de_install : Proc(INetCfgClassSetup*, Void*, Win32cr::NetworkManagement::NetManagement::OBO_TOKEN*, Win32cr::Foundation::PWSTR*, Win32cr::Foundation::HRESULT)
  ...
  record INetCfgClassSetup, lpVtbl : INetCfgClassSetupVtbl* do
    ...
    def select_and_install(this : INetCfgClassSetup*, hwndParent : Win32cr::Foundation::HWND, pOboToken : Win32cr::NetworkManagement::NetManagement::OBO_TOKEN*, ppnccItem : Void**) : Win32cr::Foundation::HRESULT
      @lpVtbl.try &.value.select_and_install.call(this, hwndParent, pOboToken, ppnccItem)
    end
    def install(this : INetCfgClassSetup*, pszwInfId : Win32cr::Foundation::PWSTR, pOboToken : Win32cr::NetworkManagement::NetManagement::OBO_TOKEN*, dwSetupFlags : UInt32, dwUpgradeFromBuildNo : UInt32, pszwAnswerFile : Win32cr::Foundation::PWSTR, pszwAnswerSections : Win32cr::Foundation::PWSTR, ppnccItem : Void**) : Win32cr::Foundation::HRESULT
      @lpVtbl.try &.value.install.call(this, pszwInfId, pOboToken, dwSetupFlags, dwUpgradeFromBuildNo, pszwAnswerFile, pszwAnswerSections, ppnccItem)
    end
    def de_install(this : INetCfgClassSetup*, pComponent : Void*, pOboToken : Win32cr::NetworkManagement::NetManagement::OBO_TOKEN*, pmszwRefs : Win32cr::Foundation::PWSTR*) : Win32cr::Foundation::HRESULT
      @lpVtbl.try &.value.de_install.call(this, pComponent, pOboToken, pmszwRefs)
    end
  ...
  record INetCfgClassSetup2Vtbl,
    ...
    select_and_install : Proc(INetCfgClassSetup2*, Win32cr::Foundation::HWND, Win32cr::NetworkManagement::NetManagement::OBO_TOKEN*, Void**, Win32cr::Foundation::HRESULT),
    install : Proc(INetCfgClassSetup2*, Win32cr::Foundation::PWSTR, Win32cr::NetworkManagement::NetManagement::OBO_TOKEN*, UInt32, UInt32, Win32cr::Foundation::PWSTR, Win32cr::Foundation::PWSTR, Void**, Win32cr::Foundation::HRESULT),
    de_install : Proc(INetCfgClassSetup2*, Void*, Win32cr::NetworkManagement::NetManagement::OBO_TOKEN*, Win32cr::Foundation::PWSTR*, Win32cr::Foundation::HRESULT),
    update_non_enumerated_component : Proc(INetCfgClassSetup2*, Void*, UInt32, UInt32, Win32cr::Foundation::HRESULT)
  ...
  record INetCfgClassSetup2, lpVtbl : INetCfgClassSetup2Vtbl* do
    ...
    def select_and_install(this : INetCfgClassSetup2*, hwndParent : Win32cr::Foundation::HWND, pOboToken : Win32cr::NetworkManagement::NetManagement::OBO_TOKEN*, ppnccItem : Void**) : Win32cr::Foundation::HRESULT
      @lpVtbl.try &.value.select_and_install.call(this, hwndParent, pOboToken, ppnccItem)
    end
    def install(this : INetCfgClassSetup2*, pszwInfId : Win32cr::Foundation::PWSTR, pOboToken : Win32cr::NetworkManagement::NetManagement::OBO_TOKEN*, dwSetupFlags : UInt32, dwUpgradeFromBuildNo : UInt32, pszwAnswerFile : Win32cr::Foundation::PWSTR, pszwAnswerSections : Win32cr::Foundation::PWSTR, ppnccItem : Void**) : Win32cr::Foundation::HRESULT
      @lpVtbl.try &.value.install.call(this, pszwInfId, pOboToken, dwSetupFlags, dwUpgradeFromBuildNo, pszwAnswerFile, pszwAnswerSections, ppnccItem)
    end
    def de_install(this : INetCfgClassSetup2*, pComponent : Void*, pOboToken : Win32cr::NetworkManagement::NetManagement::OBO_TOKEN*, pmszwRefs : Win32cr::Foundation::PWSTR*) : Win32cr::Foundation::HRESULT
      @lpVtbl.try &.value.de_install.call(this, pComponent, pOboToken, pmszwRefs)
    end
    def update_non_enumerated_component(this : INetCfgClassSetup2*, pIComp : Void*, dwSetupFlags : UInt32, dwUpgradeFromBuildNo : UInt32) : Win32cr::Foundation::HRESULT
      @lpVtbl.try &.value.update_non_enumerated_component.call(this, pIComp, dwSetupFlags, dwUpgradeFromBuildNo)
    end
  ...
  record INetCfgComponentVtbl,
    ...
    get_display_name : Proc(INetCfgComponent*, Win32cr::Foundation::PWSTR*, Win32cr::Foundation::HRESULT),
    set_display_name : Proc(INetCfgComponent*, Win32cr::Foundation::PWSTR, Win32cr::Foundation::HRESULT),
    get_help_text : Proc(INetCfgComponent*, Win32cr::Foundation::PWSTR*, Win32cr::Foundation::HRESULT),
    get_id : Proc(INetCfgComponent*, Win32cr::Foundation::PWSTR*, Win32cr::Foundation::HRESULT),
    get_characteristics : Proc(INetCfgComponent*, UInt32*, Win32cr::Foundation::HRESULT),
    get_instance_guid : Proc(INetCfgComponent*, LibC::GUID*, Win32cr::Foundation::HRESULT),
    get_pnp_dev_node_id : Proc(INetCfgComponent*, Win32cr::Foundation::PWSTR*, Win32cr::Foundation::HRESULT),
    get_class_guid : Proc(INetCfgComponent*, LibC::GUID*, Win32cr::Foundation::HRESULT),
    get_bind_name : Proc(INetCfgComponent*, Win32cr::Foundation::PWSTR*, Win32cr::Foundation::HRESULT),
    get_device_status : Proc(INetCfgComponent*, UInt32*, Win32cr::Foundation::HRESULT),
    open_param_key : Proc(INetCfgComponent*, Win32cr::System::Registry::HKEY*, Win32cr::Foundation::HRESULT),
    raise_property_ui : Proc(INetCfgComponent*, Win32cr::Foundation::HWND, UInt32, Void*, Win32cr::Foundation::HRESULT)
  ...
  record INetCfgComponent, lpVtbl : INetCfgComponentVtbl* do
    ...
    def get_display_name(this : INetCfgComponent*, ppszwDisplayName : Win32cr::Foundation::PWSTR*) : Win32cr::Foundation::HRESULT
      @lpVtbl.try &.value.get_display_name.call(this, ppszwDisplayName)
    end
    def set_display_name(this : INetCfgComponent*, pszwDisplayName : Win32cr::Foundation::PWSTR) : Win32cr::Foundation::HRESULT
      @lpVtbl.try &.value.set_display_name.call(this, pszwDisplayName)
    end
    def get_help_text(this : INetCfgComponent*, pszwHelpText : Win32cr::Foundation::PWSTR*) : Win32cr::Foundation::HRESULT
      @lpVtbl.try &.value.get_help_text.call(this, pszwHelpText)
    end
    def get_id(this : INetCfgComponent*, ppszwId : Win32cr::Foundation::PWSTR*) : Win32cr::Foundation::HRESULT
      @lpVtbl.try &.value.get_id.call(this, ppszwId)
    end
    def get_characteristics(this : INetCfgComponent*, pdwCharacteristics : UInt32*) : Win32cr::Foundation::HRESULT
      @lpVtbl.try &.value.get_characteristics.call(this, pdwCharacteristics)
    end
    def get_instance_guid(this : INetCfgComponent*, pGuid : LibC::GUID*) : Win32cr::Foundation::HRESULT
      @lpVtbl.try &.value.get_instance_guid.call(this, pGuid)
    end
    def get_pnp_dev_node_id(this : INetCfgComponent*, ppszwDevNodeId : Win32cr::Foundation::PWSTR*) : Win32cr::Foundation::HRESULT
      @lpVtbl.try &.value.get_pnp_dev_node_id.call(this, ppszwDevNodeId)
    end
    def get_class_guid(this : INetCfgComponent*, pGuid : LibC::GUID*) : Win32cr::Foundation::HRESULT
      @lpVtbl.try &.value.get_class_guid.call(this, pGuid)
    end
    def get_bind_name(this : INetCfgComponent*, ppszwBindName : Win32cr::Foundation::PWSTR*) : Win32cr::Foundation::HRESULT
      @lpVtbl.try &.value.get_bind_name.call(this, ppszwBindName)
    end
    def get_device_status(this : INetCfgComponent*, pulStatus : UInt32*) : Win32cr::Foundation::HRESULT
      @lpVtbl.try &.value.get_device_status.call(this, pulStatus)
    end
    def open_param_key(this : INetCfgComponent*, phkey : Win32cr::System::Registry::HKEY*) : Win32cr::Foundation::HRESULT
      @lpVtbl.try &.value.open_param_key.call(this, phkey)
    end
    def raise_property_ui(this : INetCfgComponent*, hwndParent : Win32cr::Foundation::HWND, dwFlags : UInt32, punkContext : Void*) : Win32cr::Foundation::HRESULT
      @lpVtbl.try &.value.raise_property_ui.call(this, hwndParent, dwFlags, punkContext)
    end
  ...
  record INetCfgComponentBindingsVtbl,
    ...
    bind_to : Proc(INetCfgComponentBindings*, Void*, Win32cr::Foundation::HRESULT),
    unbind_from : Proc(INetCfgComponentBindings*, Void*, Win32cr::Foundation::HRESULT),
    supports_binding_interface : Proc(INetCfgComponentBindings*, UInt32, Win32cr::Foundation::PWSTR, Win32cr::Foundation::HRESULT),
    is_bound_to : Proc(INetCfgComponentBindings*, Void*, Win32cr::Foundation::HRESULT),
    is_bindable_to : Proc(INetCfgComponentBindings*, Void*, Win32cr::Foundation::HRESULT),
    enum_binding_paths : Proc(INetCfgComponentBindings*, UInt32, Void**, Win32cr::Foundation::HRESULT),
    move_before : Proc(INetCfgComponentBindings*, Void*, Void*, Win32cr::Foundation::HRESULT),
    move_after : Proc(INetCfgComponentBindings*, Void*, Void*, Win32cr::Foundation::HRESULT)
  ...
  record INetCfgComponentBindings, lpVtbl : INetCfgComponentBindingsVtbl* do
    ...
    def bind_to(this : INetCfgComponentBindings*, pnccItem : Void*) : Win32cr::Foundation::HRESULT
      @lpVtbl.try &.value.bind_to.call(this, pnccItem)
    end
    def unbind_from(this : INetCfgComponentBindings*, pnccItem : Void*) : Win32cr::Foundation::HRESULT
      @lpVtbl.try &.value.unbind_from.call(this, pnccItem)
    end
    def supports_binding_interface(this : INetCfgComponentBindings*, dwFlags : UInt32, pszwInterfaceName : Win32cr::Foundation::PWSTR) : Win32cr::Foundation::HRESULT
      @lpVtbl.try &.value.supports_binding_interface.call(this, dwFlags, pszwInterfaceName)
    end
    def is_bound_to(this : INetCfgComponentBindings*, pnccItem : Void*) : Win32cr::Foundation::HRESULT
      @lpVtbl.try &.value.is_bound_to.call(this, pnccItem)
    end
    def is_bindable_to(this : INetCfgComponentBindings*, pnccItem : Void*) : Win32cr::Foundation::HRESULT
      @lpVtbl.try &.value.is_bindable_to.call(this, pnccItem)
    end
    def enum_binding_paths(this : INetCfgComponentBindings*, dwFlags : UInt32, ppIEnum : Void**) : Win32cr::Foundation::HRESULT
      @lpVtbl.try &.value.enum_binding_paths.call(this, dwFlags, ppIEnum)
    end
    def move_before(this : INetCfgComponentBindings*, pncbItemSrc : Void*, pncbItemDest : Void*) : Win32cr::Foundation::HRESULT
      @lpVtbl.try &.value.move_before.call(this, pncbItemSrc, pncbItemDest)
    end
    def move_after(this : INetCfgComponentBindings*, pncbItemSrc : Void*, pncbItemDest : Void*) : Win32cr::Foundation::HRESULT
      @lpVtbl.try &.value.move_after.call(this, pncbItemSrc, pncbItemDest)
    end
  ...
  record INetCfgSysPrepVtbl,
    ...
    hr_setup_set_first_dword : Proc(INetCfgSysPrep*, Win32cr::Foundation::PWSTR, Win32cr::Foundation::PWSTR, UInt32, Win32cr::Foundation::HRESULT),
    hr_setup_set_first_string : Proc(INetCfgSysPrep*, Win32cr::Foundation::PWSTR, Win32cr::Foundation::PWSTR, Win32cr::Foundation::PWSTR, Win32cr::Foundation::HRESULT),
    hr_setup_set_first_string_as_bool : Proc(INetCfgSysPrep*, Win32cr::Foundation::PWSTR, Win32cr::Foundation::PWSTR, Win32cr::Foundation::BOOL, Win32cr::Foundation::HRESULT),
    hr_setup_set_first_multi_sz_field : Proc(INetCfgSysPrep*, Win32cr::Foundation::PWSTR, Win32cr::Foundation::PWSTR, Win32cr::Foundation::PWSTR, Win32cr::Foundation::HRESULT)
  ...
  record INetCfgSysPrep, lpVtbl : INetCfgSysPrepVtbl* do
    ...
    def hr_setup_set_first_dword(this : INetCfgSysPrep*, pwszSection : Win32cr::Foundation::PWSTR, pwszKey : Win32cr::Foundation::PWSTR, dwValue : UInt32) : Win32cr::Foundation::HRESULT
      @lpVtbl.try &.value.hr_setup_set_first_dword.call(this, pwszSection, pwszKey, dwValue)
    end
    def hr_setup_set_first_string(this : INetCfgSysPrep*, pwszSection : Win32cr::Foundation::PWSTR, pwszKey : Win32cr::Foundation::PWSTR, pwszValue : Win32cr::Foundation::PWSTR) : Win32cr::Foundation::HRESULT
      @lpVtbl.try &.value.hr_setup_set_first_string.call(this, pwszSection, pwszKey, pwszValue)
    end
    def hr_setup_set_first_string_as_bool(this : INetCfgSysPrep*, pwszSection : Win32cr::Foundation::PWSTR, pwszKey : Win32cr::Foundation::PWSTR, fValue : Win32cr::Foundation::BOOL) : Win32cr::Foundation::HRESULT
      @lpVtbl.try &.value.hr_setup_set_first_string_as_bool.call(this, pwszSection, pwszKey, fValue)
    end
    def hr_setup_set_first_multi_sz_field(this : INetCfgSysPrep*, pwszSection : Win32cr::Foundation::PWSTR, pwszKey : Win32cr::Foundation::PWSTR, pmszValue : Win32cr::Foundation::PWSTR) : Win32cr::Foundation::HRESULT
      @lpVtbl.try &.value.hr_setup_set_first_multi_sz_field.call(this, pwszSection, pwszKey, pmszValue)
    end
  ...
  record INetCfgPnpReconfigCallbackVtbl,
    ...
    send_pnp_reconfig : Proc(INetCfgPnpReconfigCallback*, Win32cr::NetworkManagement::NetManagement::NCPNP_RECONFIG_LAYER, Win32cr::Foundation::PWSTR, Win32cr::Foundation::PWSTR, Void*, UInt32, Win32cr::Foundation::HRESULT)
  ...
  record INetCfgPnpReconfigCallback, lpVtbl : INetCfgPnpReconfigCallbackVtbl* do
    ...
    def send_pnp_reconfig(this : INetCfgPnpReconfigCallback*, layer : Win32cr::NetworkManagement::NetManagement::NCPNP_RECONFIG_LAYER, pszwUpper : Win32cr::Foundation::PWSTR, pszwLower : Win32cr::Foundation::PWSTR, pvData : Void*, dwSizeOfData : UInt32) : Win32cr::Foundation::HRESULT
      @lpVtbl.try &.value.send_pnp_reconfig.call(this, layer, pszwUpper, pszwLower, pvData, dwSizeOfData)
    end
  ...
  record INetCfgComponentControlVtbl,
    ...
    initialize__ : Proc(INetCfgComponentControl*, Void*, Void*, Win32cr::Foundation::BOOL, Win32cr::Foundation::HRESULT),
    apply_registry_changes : Proc(INetCfgComponentControl*, Win32cr::Foundation::HRESULT),
    apply_pnp_changes : Proc(INetCfgComponentControl*, Void*, Win32cr::Foundation::HRESULT),
    cancel_changes : Proc(INetCfgComponentControl*, Win32cr::Foundation::HRESULT)
  ...
  record INetCfgComponentControl, lpVtbl : INetCfgComponentControlVtbl* do
    ...
    def initialize__(this : INetCfgComponentControl*, pIComp : Void*, pINetCfg : Void*, fInstalling : Win32cr::Foundation::BOOL) : Win32cr::Foundation::HRESULT
      @lpVtbl.try &.value.initialize__.call(this, pIComp, pINetCfg, fInstalling)
    end
    def apply_registry_changes(this : INetCfgComponentControl*) : Win32cr::Foundation::HRESULT
      @lpVtbl.try &.value.apply_registry_changes.call(this)
    end
    def apply_pnp_changes(this : INetCfgComponentControl*, pICallback : Void*) : Win32cr::Foundation::HRESULT
      @lpVtbl.try &.value.apply_pnp_changes.call(this, pICallback)
    end
    def cancel_changes(this : INetCfgComponentControl*) : Win32cr::Foundation::HRESULT
      @lpVtbl.try &.value.cancel_changes.call(this)
    end
  ...
  record INetCfgComponentSetupVtbl,
    ...
    install : Proc(INetCfgComponentSetup*, UInt32, Win32cr::Foundation::HRESULT),
    upgrade : Proc(INetCfgComponentSetup*, UInt32, UInt32, Win32cr::Foundation::HRESULT),
    read_answer_file : Proc(INetCfgComponentSetup*, Win32cr::Foundation::PWSTR, Win32cr::Foundation::PWSTR, Win32cr::Foundation::HRESULT),
    removing : Proc(INetCfgComponentSetup*, Win32cr::Foundation::HRESULT)
  ...
  record INetCfgComponentSetup, lpVtbl : INetCfgComponentSetupVtbl* do
    ...
    def install(this : INetCfgComponentSetup*, dwSetupFlags : UInt32) : Win32cr::Foundation::HRESULT
      @lpVtbl.try &.value.install.call(this, dwSetupFlags)
    end
    def upgrade(this : INetCfgComponentSetup*, dwSetupFlags : UInt32, dwUpgradeFomBuildNo : UInt32) : Win32cr::Foundation::HRESULT
      @lpVtbl.try &.value.upgrade.call(this, dwSetupFlags, dwUpgradeFomBuildNo)
    end
    def read_answer_file(this : INetCfgComponentSetup*, pszwAnswerFile : Win32cr::Foundation::PWSTR, pszwAnswerSections : Win32cr::Foundation::PWSTR) : Win32cr::Foundation::HRESULT
      @lpVtbl.try &.value.read_answer_file.call(this, pszwAnswerFile, pszwAnswerSections)
    end
    def removing(this : INetCfgComponentSetup*) : Win32cr::Foundation::HRESULT
      @lpVtbl.try &.value.removing.call(this)
    end
  ...
  record INetCfgComponentPropertyUiVtbl,
    ...
    query_property_ui : Proc(INetCfgComponentPropertyUi*, Void*, Win32cr::Foundation::HRESULT),
    set_context : Proc(INetCfgComponentPropertyUi*, Void*, Win32cr::Foundation::HRESULT),
    merge_prop_pages : Proc(INetCfgComponentPropertyUi*, UInt32*, UInt8**, UInt32*, Win32cr::Foundation::HWND, Win32cr::Foundation::PWSTR*, Win32cr::Foundation::HRESULT),
    validate_properties : Proc(INetCfgComponentPropertyUi*, Win32cr::Foundation::HWND, Win32cr::Foundation::HRESULT),
    apply_properties : Proc(INetCfgComponentPropertyUi*, Win32cr::Foundation::HRESULT),
    cancel_properties : Proc(INetCfgComponentPropertyUi*, Win32cr::Foundation::HRESULT)
  ...
  record INetCfgComponentPropertyUi, lpVtbl : INetCfgComponentPropertyUiVtbl* do
    ...
    def query_property_ui(this : INetCfgComponentPropertyUi*, pUnkReserved : Void*) : Win32cr::Foundation::HRESULT
      @lpVtbl.try &.value.query_property_ui.call(this, pUnkReserved)
    end
    def set_context(this : INetCfgComponentPropertyUi*, pUnkReserved : Void*) : Win32cr::Foundation::HRESULT
      @lpVtbl.try &.value.set_context.call(this, pUnkReserved)
    end
    def merge_prop_pages(this : INetCfgComponentPropertyUi*, pdwDefPages : UInt32*, pahpspPrivate : UInt8**, pcPages : UInt32*, hwndParent : Win32cr::Foundation::HWND, pszStartPage : Win32cr::Foundation::PWSTR*) : Win32cr::Foundation::HRESULT
      @lpVtbl.try &.value.merge_prop_pages.call(this, pdwDefPages, pahpspPrivate, pcPages, hwndParent, pszStartPage)
    end
    def validate_properties(this : INetCfgComponentPropertyUi*, hwndSheet : Win32cr::Foundation::HWND) : Win32cr::Foundation::HRESULT
      @lpVtbl.try &.value.validate_properties.call(this, hwndSheet)
    end
    def apply_properties(this : INetCfgComponentPropertyUi*) : Win32cr::Foundation::HRESULT
      @lpVtbl.try &.value.apply_properties.call(this)
    end
    def cancel_properties(this : INetCfgComponentPropertyUi*) : Win32cr::Foundation::HRESULT
      @lpVtbl.try &.value.cancel_properties.call(this)
    end
  ...
  record INetCfgComponentNotifyBindingVtbl,
    ...
    query_binding_path : Proc(INetCfgComponentNotifyBinding*, UInt32, Void*, Win32cr::Foundation::HRESULT),
    notify_binding_path : Proc(INetCfgComponentNotifyBinding*, UInt32, Void*, Win32cr::Foundation::HRESULT)
  ...
  record INetCfgComponentNotifyBinding, lpVtbl : INetCfgComponentNotifyBindingVtbl* do
    ...
    def query_binding_path(this : INetCfgComponentNotifyBinding*, dwChangeFlag : UInt32, pIPath : Void*) : Win32cr::Foundation::HRESULT
      @lpVtbl.try &.value.query_binding_path.call(this, dwChangeFlag, pIPath)
    end
    def notify_binding_path(this : INetCfgComponentNotifyBinding*, dwChangeFlag : UInt32, pIPath : Void*) : Win32cr::Foundation::HRESULT
      @lpVtbl.try &.value.notify_binding_path.call(this, dwChangeFlag, pIPath)
    end
  ...
  record INetCfgComponentNotifyGlobalVtbl,
    ...
    get_supported_notifications : Proc(INetCfgComponentNotifyGlobal*, UInt32*, Win32cr::Foundation::HRESULT),
    sys_query_binding_path : Proc(INetCfgComponentNotifyGlobal*, UInt32, Void*, Win32cr::Foundation::HRESULT),
    sys_notify_binding_path : Proc(INetCfgComponentNotifyGlobal*, UInt32, Void*, Win32cr::Foundation::HRESULT),
    sys_notify_component : Proc(INetCfgComponentNotifyGlobal*, UInt32, Void*, Win32cr::Foundation::HRESULT)
  ...
  record INetCfgComponentNotifyGlobal, lpVtbl : INetCfgComponentNotifyGlobalVtbl* do
    ...
    def get_supported_notifications(this : INetCfgComponentNotifyGlobal*, dwNotifications : UInt32*) : Win32cr::Foundation::HRESULT
      @lpVtbl.try &.value.get_supported_notifications.call(this, dwNotifications)
    end
    def sys_query_binding_path(this : INetCfgComponentNotifyGlobal*, dwChangeFlag : UInt32, pIPath : Void*) : Win32cr::Foundation::HRESULT
      @lpVtbl.try &.value.sys_query_binding_path.call(this, dwChangeFlag, pIPath)
    end
    def sys_notify_binding_path(this : INetCfgComponentNotifyGlobal*, dwChangeFlag : UInt32, pIPath : Void*) : Win32cr::Foundation::HRESULT
      @lpVtbl.try &.value.sys_notify_binding_path.call(this, dwChangeFlag, pIPath)
    end
    def sys_notify_component(this : INetCfgComponentNotifyGlobal*, dwChangeFlag : UInt32, pIComp : Void*) : Win32cr::Foundation::HRESULT
      @lpVtbl.try &.value.sys_notify_component.call(this, dwChangeFlag, pIComp)
    end
  ...
  record INetCfgComponentUpperEdgeVtbl,
    ...
    get_interface_ids_for_adapter : Proc(INetCfgComponentUpperEdge*, Void*, UInt32*, LibC::GUID**, Win32cr::Foundation::HRESULT),
    add_interfaces_to_adapter : Proc(INetCfgComponentUpperEdge*, Void*, UInt32, Win32cr::Foundation::HRESULT),
    remove_interfaces_from_adapter : Proc(INetCfgComponentUpperEdge*, Void*, UInt32, LibC::GUID*, Win32cr::Foundation::HRESULT)
  ...
  record INetCfgComponentUpperEdge, lpVtbl : INetCfgComponentUpperEdgeVtbl* do
    ...
    def get_interface_ids_for_adapter(this : INetCfgComponentUpperEdge*, pAdapter : Void*, pdwNumInterfaces : UInt32*, ppguidInterfaceIds : LibC::GUID**) : Win32cr::Foundation::HRESULT
      @lpVtbl.try &.value.get_interface_ids_for_adapter.call(this, pAdapter, pdwNumInterfaces, ppguidInterfaceIds)
    end
    def add_interfaces_to_adapter(this : INetCfgComponentUpperEdge*, pAdapter : Void*, dwNumInterfaces : UInt32) : Win32cr::Foundation::HRESULT
      @lpVtbl.try &.value.add_interfaces_to_adapter.call(this, pAdapter, dwNumInterfaces)
    end
    def remove_interfaces_from_adapter(this : INetCfgComponentUpperEdge*, pAdapter : Void*, dwNumInterfaces : UInt32, pguidInterfaceIds : LibC::GUID*) : Win32cr::Foundation::HRESULT
      @lpVtbl.try &.value.remove_interfaces_from_adapter.call(this, pAdapter, dwNumInterfaces, pguidInterfaceIds)
    end
  ...
  record INetLanConnectionUiInfoVtbl,
    ...
    get_device_guid : Proc(INetLanConnectionUiInfo*, LibC::GUID*, Win32cr::Foundation::HRESULT)
  ...
  record INetLanConnectionUiInfo, lpVtbl : INetLanConnectionUiInfoVtbl* do
    ...
    def get_device_guid(this : INetLanConnectionUiInfo*, pguid : LibC::GUID*) : Win32cr::Foundation::HRESULT
      @lpVtbl.try &.value.get_device_guid.call(this, pguid)
    end
  ...
  record INetRasConnectionIpUiInfoVtbl,
    ...
    get_ui_info : Proc(INetRasConnectionIpUiInfo*, Win32cr::NetworkManagement::NetManagement::RASCON_IPUI*, Win32cr::Foundation::HRESULT)
  ...
  record INetRasConnectionIpUiInfo, lpVtbl : INetRasConnectionIpUiInfoVtbl* do
    ...
    def get_ui_info(this : INetRasConnectionIpUiInfo*, pInfo : Win32cr::NetworkManagement::NetManagement::RASCON_IPUI*) : Win32cr::Foundation::HRESULT
      @lpVtbl.try &.value.get_ui_info.call(this, pInfo)
    end
  ...
  record INetCfgComponentSysPrepVtbl,
    ...
    save_adapter_parameters : Proc(INetCfgComponentSysPrep*, Void*, Win32cr::Foundation::PWSTR, LibC::GUID*, Win32cr::Foundation::HRESULT),
    restore_adapter_parameters : Proc(INetCfgComponentSysPrep*, Win32cr::Foundation::PWSTR, Win32cr::Foundation::PWSTR, LibC::GUID*, Win32cr::Foundation::HRESULT)
  ...
  record INetCfgComponentSysPrep, lpVtbl : INetCfgComponentSysPrepVtbl* do
    ...
    def save_adapter_parameters(this : INetCfgComponentSysPrep*, pncsp : Void*, pszwAnswerSections : Win32cr::Foundation::PWSTR, pAdapterInstanceGuid : LibC::GUID*) : Win32cr::Foundation::HRESULT
      @lpVtbl.try &.value.save_adapter_parameters.call(this, pncsp, pszwAnswerSections, pAdapterInstanceGuid)
    end
    def restore_adapter_parameters(this : INetCfgComponentSysPrep*, pszwAnswerFile : Win32cr::Foundation::PWSTR, pszwAnswerSection : Win32cr::Foundation::PWSTR, pAdapterInstanceGuid : LibC::GUID*) : Win32cr::Foundation::HRESULT
      @lpVtbl.try &.value.restore_adapter_parameters.call(this, pszwAnswerFile, pszwAnswerSection, pAdapterInstanceGuid)
    end
  ...
  record IProvisioningDomainVtbl,
    ...
    add : Proc(IProvisioningDomain*, Win32cr::Foundation::PWSTR, Win32cr::Foundation::HRESULT),
    query : Proc(IProvisioningDomain*, Win32cr::Foundation::PWSTR, Win32cr::Foundation::PWSTR, Win32cr::Foundation::PWSTR, Void**, Win32cr::Foundation::HRESULT)
  ...
  record IProvisioningDomain, lpVtbl : IProvisioningDomainVtbl* do
    ...
    def add(this : IProvisioningDomain*, pszwPathToFolder : Win32cr::Foundation::PWSTR) : Win32cr::Foundation::HRESULT
      @lpVtbl.try &.value.add.call(this, pszwPathToFolder)
    end
    def query(this : IProvisioningDomain*, pszwDomain : Win32cr::Foundation::PWSTR, pszwLanguage : Win32cr::Foundation::PWSTR, pszwXPathQuery : Win32cr::Foundation::PWSTR, nodes : Void**) : Win32cr::Foundation::HRESULT
      @lpVtbl.try &.value.query.call(this, pszwDomain, pszwLanguage, pszwXPathQuery, nodes)
    end
  ...
  record IProvisioningProfileWirelessVtbl,
    ...
    create_profile : Proc(IProvisioningProfileWireless*, Win32cr::Foundation::BSTR, Win32cr::Foundation::BSTR, LibC::GUID*, UInt32*, Win32cr::Foundation::HRESULT)
  ...
  record IProvisioningProfileWireless, lpVtbl : IProvisioningProfileWirelessVtbl* do
    ...
    def create_profile(this : IProvisioningProfileWireless*, bstrXMLWirelessConfigProfile : Win32cr::Foundation::BSTR, bstrXMLConnectionConfigProfile : Win32cr::Foundation::BSTR, pAdapterInstanceGuid : LibC::GUID*, pulStatus : UInt32*) : Win32cr::Foundation::HRESULT
      @lpVtbl.try &.value.create_profile.call(this, bstrXMLWirelessConfigProfile, bstrXMLConnectionConfigProfile, pAdapterInstanceGuid, pulStatus)
    end
