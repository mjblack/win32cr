...
module Win32cr::NetworkManagement::Dns
  ...
  record DNS_CONNECTION_PROXY_INFO,
    ...
    record Anonymous_e__Union,
      config : DNS_CONNECTION_PROXY_INFO_CONFIG,
      script : DNS_CONNECTION_PROXY_INFO_SCRIPT do

      # Nested Type DNS_CONNECTION_PROXY_INFO_SCRIPT
      @[Extern]
      record DNS_CONNECTION_PROXY_INFO_SCRIPT,
        pwszScript : Win32cr::Foundation::PWSTR,
        pwszUsername : Win32cr::Foundation::PWSTR,
        pwszPassword : Win32cr::Foundation::PWSTR


      # Nested Type DNS_CONNECTION_PROXY_INFO_CONFIG
      @[Extern]
      record DNS_CONNECTION_PROXY_INFO_CONFIG,
