...
module Win32cr::NetworkManagement::Rras
  ...
  record MPR_VPN_TRAFFIC_SELECTORS,
    numTsi : UInt32,
    numTsr : UInt32,
    tsI : Win32cr::NetworkManagement::Rras::MPR_VPN_SELECTOR*,
    tsR : Win32cr::NetworkManagement::Rras::MPR_VPN_SELECTOR*
  ...
  record RTM_DEST_INFO,
    ...
    number_of_views : UInt32,
    view_info : Anonymous_e__Struct* do
