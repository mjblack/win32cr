...
module Win32cr::NetworkManagement::WindowsFilteringPlatform
  ...
  record IKEEXT_CERTIFICATE_AUTHENTICATION2,
    ...
    record Anonymous2_e__Union,
      ...
      anonymous3 : Anonymous3_e__Struct do
      ...
      # Nested Type Anonymous3_e__Struct
      @[Extern]
      record Anonymous3_e__Struct,
  ...
  record FWPM_VSWITCH_EVENT0,
    ...
    @[Extern(union: true)]
    record Anonymous_e__Union,
      positionInfo : Positioninfo_e__struct,
      reorderInfo : Reorderinfo_e__struct do

      # Nested Type Positioninfo_e__struct
      @[Extern]
      record Positioninfo_e__struct,
        numvSwitchFilterExtensions : UInt32,
        vSwitchFilterExtensions : Win32cr::Foundation::PWSTR*


      # Nested Type Reorderinfo_e__struct
      @[Extern]
      record Reorderinfo_e__struct,
