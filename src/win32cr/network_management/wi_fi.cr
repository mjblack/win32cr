...
module Win32cr::NetworkManagement::WiFi
  ...
  @[Extern]
  record DOT11_WME_AC_PARAMTERS_LIST,
    uNumOfEntries : UInt32,
    uTotalNumOfEntries : UInt32,
  ...
  record DOT11_BSS_ENTRY_PHY_SPECIFIC_INFO,
    uChCenterFrequency : UInt32,
    fhss : FHSS_e__Struct do

    # Nested Type FHSS_e__Struct
    @[Extern]
    record FHSS_e__Struct,
      uHopPattern : UInt32,
      uHopSet : UInt32,
      uDwellTime : UInt32
  ...
  record DOT11_PHY_ATTRIBUTES,
    ...
    phy_specific_attributes : PhySpecificAttributes_e__Union,
    ...
    # Nested Type PhySpecificAttributes_e__Union
    @[Extern(union: true)]
    record PhySpecificAttributes_e__Union,
      hrdsss_attributes : Win32cr::NetworkManagement::WiFi::DOT11_HRDSSS_PHY_ATTRIBUTES,
  ...
  record WLAN_RAW_DATA_LIST,
    ...
    data_list : Anonymous_e__Struct* do
