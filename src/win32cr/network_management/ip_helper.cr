...
module Win32cr::NetworkManagement::IpHelper
  ...
  record MIB_IF_ROW2,
    ...
    interface_and_oper_status_flags : InterfaceAndOperStatusFlags_e__Struct,
    ...
    # Nested Type InterfaceAndOperStatusFlags_e__Struct
    @[Extern]
    record InterfaceAndOperStatusFlags_e__Struct,
      _bitfield : UInt8
  ...
  record MIB_IPNET_ROW2,
    ...
    anonymous : Anonymous_e__Union,
    reachability_time : ReachabilityTime_e__Union do
    ...
    # Nested Type ReachabilityTime_e__Union
    @[Extern(union: true)]
    record ReachabilityTime_e__Union,
      last_reachable : UInt32,
      last_unreachable : UInt32
