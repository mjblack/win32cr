...
module Win32cr::NetworkManagement::QoS
  ...
  record RSVP_SESSION,
    ...
    sess_u : Sess_u_e__union do

    # Nested Type Sess_u_e__union
    @[Extern(union: true)]
    record Sess_u_e__union,
  ...
  record RSVP_HOP,
    ...
    hop_u : Hop_u_e__union do

    # Nested Type Hop_u_e__union
    @[Extern(union: true)]
    record Hop_u_e__union,
  ...
  record FILTER_SPEC,
    ...
    filt_u : Filt_u_e__union do

    # Nested Type Filt_u_e__union
    @[Extern(union: true)]
    record Filt_u_e__union,
  ...
  record RSVP_SCOPE,
    ...
    scope_u : Scope_u_e__union do

    # Nested Type Scope_u_e__union
    @[Extern(union: true)]
    record Scope_u_e__union,
  ...
  record ERROR_SPEC,
    ...
    errs_u : Errs_u_e__union do

    # Nested Type Errs_u_e__union
    @[Extern(union: true)]
    record Errs_u_e__union,
  ...
  record IntServTspecBody,
    ...
    tspec_u : Tspec_u_e__union do

    # Nested Type Tspec_u_e__union
    @[Extern(union: true)]
    record Tspec_u_e__union,
  ...
  record IntServFlowSpec,
    ...
    spec_u : Spec_u_e__union do

    # Nested Type Spec_u_e__union
    @[Extern(union: true)]
    record Spec_u_e__union,
  ...
  record IP_PATTERN,
    ...
    # Nested Type S_un_e__Union
    @[Extern(union: true)]
    record S_un_e__Union,
      s_un_ports : S_un_ports_e__Struct,
      s_un_icmp : S_un_icmp_e__Struct,
      s_spi : UInt32 do

      # Nested Type S_un_icmp_e__Struct
      @[Extern]
      record S_un_icmp_e__Struct,
        s_type : UInt8,
        s_code : UInt8,
        filler : UInt16


      # Nested Type S_un_ports_e__Struct
      @[Extern]
      record S_un_ports_e__Struct,
        s_srcport : UInt16,
        s_dstport : UInt16
  ...
  record IPX_PATTERN,
    src : Src_e__Struct,
    dest : Src_e__Struct do

    # Nested Type Src_e__Struct
    @[Extern]
    record Src_e__Struct,
  ...
  @[Extern]
  record SIPAEVENT_VSM_IDK_RSA_INFO,
  ...
  @[Extern]
  record SIPAEVENT_VSM_IDK_INFO_PAYLOAD,
    key_alg_id : UInt32,
    anonymous : Anonymous_e__Union do
    ...
    @[Extern(union: true)]
    record Anonymous_e__Union,
      rsa_key_info : Win32cr::NetworkManagement::QoS::SIPAEVENT_VSM_IDK_RSA_INFO

  end

  @[Extern]
  record SIPAEVENT_SI_POLICY_PAYLOAD,
  ...
  @[Extern]
  record SIPAEVENT_REVOCATION_LIST_PAYLOAD,
    creation_time : Int64,
    digest_length : UInt32,
    hash_alg_id : UInt16,
    digest : UInt8*
  ...
  @[Extern]
  record SIPAEVENT_KSR_SIGNATURE_PAYLOAD,
    sign_alg_id : UInt32,
    signature_length : UInt32,
    signature : UInt8*

  @[Extern]
  record SIPAEVENT_SBCP_INFO_PAYLOAD_V1,
