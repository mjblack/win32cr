...
module Win32cr::Storage::InstallableFileSystems
  ...
  record FILTER_AGGREGATE_BASIC_INFORMATION,
    next_entry_offset : UInt32,
    flags : UInt32,
    type__ : Type_e__Union do

    # Nested Type Type_e__Union
    @[Extern(union: true)]
    record Type_e__Union,
      mini_filter : MiniFilter_e__Struct,
      legacy_filter : LegacyFilter_e__Struct do

      # Nested Type MiniFilter_e__Struct
      @[Extern]
      record MiniFilter_e__Struct,
        frame_id : UInt32,
        number_of_instances : UInt32,
        filter_name_length : UInt16,
      ...
      # Nested Type LegacyFilter_e__Struct
      @[Extern]
      record LegacyFilter_e__Struct,
        filter_name_length : UInt16,
        filter_name_buffer_offset : UInt16
