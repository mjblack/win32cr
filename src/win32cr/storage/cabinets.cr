...
module Win32cr::Storage::Cabinets
  ...
  record FDIDECRYPT,
    ...
    record Anonymous_e__Union,
      cabinet : Cabinet_e__struct,
      folder : Folder_e__struct,
      decrypt : Decrypt_e__struct do

      # Nested Type Decrypt_e__struct
      @[Extern]
      record Decrypt_e__struct,
        pDataReserve : Void*,
      ...
      # Nested Type Cabinet_e__struct
      @[Extern]
      record Cabinet_e__struct,
        pHeaderReserve : Void*,
      ...
      # Nested Type Folder_e__struct
      @[Extern]
      record Folder_e__struct,
        pFolderReserve : Void*,
