...
module Win32cr::Storage::CloudFilters
  ...
  record CF_CALLBACK_PARAMETERS,
    ...
    record Anonymous_e__Union,
      cancel : Cancel_e__Struct,
      fetch_data : FetchData_e__Struct,
      validate_data : ValidateData_e__Struct,
      fetch_placeholders : FetchPlaceholders_e__Struct,
      open_completion : OpenCompletion_e__Struct,
      close_completion : CloseCompletion_e__Struct,
      dehydrate : Dehydrate_e__Struct,
      dehydrate_completion : DehydrateCompletion_e__Struct,
      delete : Delete_e__Struct,
      delete_completion : DeleteCompletion_e__Struct,
      rename : Rename_e__Struct,
      rename_completion : RenameCompletion_e__Struct do

      # Nested Type Rename_e__Struct
      @[Extern]
      record Rename_e__Struct,
        flags : Win32cr::Storage::CloudFilters::CF_CALLBACK_RENAME_FLAGS,
        target_path : Win32cr::Foundation::PWSTR


      # Nested Type Delete_e__Struct
      @[Extern]
      record Delete_e__Struct,
        flags : Win32cr::Storage::CloudFilters::CF_CALLBACK_DELETE_FLAGS


      # Nested Type Dehydrate_e__Struct
      @[Extern]
      record Dehydrate_e__Struct,
      ...
      # Nested Type OpenCompletion_e__Struct
      @[Extern]
      record OpenCompletion_e__Struct,
        flags : Win32cr::Storage::CloudFilters::CF_CALLBACK_OPEN_COMPLETION_FLAGS


      # Nested Type ValidateData_e__Struct
      @[Extern]
      record ValidateData_e__Struct,
      ...
      # Nested Type Cancel_e__Struct
      @[Extern]
      record Cancel_e__Struct,
        ...
        @[Extern(union: true)]
        record Anonymous_e__Union,
          fetch_data : FetchData_e__Struct do

          # Nested Type FetchData_e__Struct
          @[Extern]
          record FetchData_e__Struct,
      ...
      # Nested Type RenameCompletion_e__Struct
      @[Extern]
      record RenameCompletion_e__Struct,
        flags : Win32cr::Storage::CloudFilters::CF_CALLBACK_RENAME_COMPLETION_FLAGS,
        source_path : Win32cr::Foundation::PWSTR


      # Nested Type DehydrateCompletion_e__Struct
      @[Extern]
      record DehydrateCompletion_e__Struct,
        flags : Win32cr::Storage::CloudFilters::CF_CALLBACK_DEHYDRATE_COMPLETION_FLAGS,
        reason : Win32cr::Storage::CloudFilters::CF_CALLBACK_DEHYDRATION_REASON


      # Nested Type FetchPlaceholders_e__Struct
      @[Extern]
      record FetchPlaceholders_e__Struct,
        flags : Win32cr::Storage::CloudFilters::CF_CALLBACK_FETCH_PLACEHOLDERS_FLAGS,
        pattern : Win32cr::Foundation::PWSTR


      # Nested Type DeleteCompletion_e__Struct
      @[Extern]
      record DeleteCompletion_e__Struct,
      ...
      # Nested Type CloseCompletion_e__Struct
      @[Extern]
      record CloseCompletion_e__Struct,
  ...
  record CF_OPERATION_PARAMETERS,
    ...
    @[Extern(union: true)]
    record Anonymous_e__Union,
      transfer_data : TransferData_e__Struct,
      retrieve_data : RetrieveData_e__Struct,
      ack_data : AckData_e__Struct,
      restart_hydration : RestartHydration_e__Struct,
      transfer_placeholders : TransferPlaceholders_e__Struct,
      ack_dehydrate : AckDehydrate_e__Struct,
      ack_rename : AckRename_e__Struct,
      ack_delete : AckDelete_e__Struct do

      # Nested Type AckRename_e__Struct
      @[Extern]
      record AckRename_e__Struct,
        flags : Win32cr::Storage::CloudFilters::CF_OPERATION_ACK_RENAME_FLAGS,
        completion_status : Win32cr::Foundation::NTSTATUS


      # Nested Type TransferPlaceholders_e__Struct
      @[Extern]
      record TransferPlaceholders_e__Struct,
      ...
      # Nested Type AckData_e__Struct
      @[Extern]
      record AckData_e__Struct,
      ...
      # Nested Type TransferData_e__Struct
      @[Extern]
      record TransferData_e__Struct,
      ...
      # Nested Type AckDelete_e__Struct
      @[Extern]
      record AckDelete_e__Struct,
        flags : Win32cr::Storage::CloudFilters::CF_OPERATION_ACK_DELETE_FLAGS,
        completion_status : Win32cr::Foundation::NTSTATUS


      # Nested Type RestartHydration_e__Struct
      @[Extern]
      record RestartHydration_e__Struct,
      ...
      # Nested Type AckDehydrate_e__Struct
      @[Extern]
      record AckDehydrate_e__Struct,
      ...
      # Nested Type RetrieveData_e__Struct
      @[Extern]
      record RetrieveData_e__Struct,
