...
module Win32cr::Storage::ProjectedFileSystem
  ...
  record PRJ_EXTENDED_INFO,
    ...
    record Anonymous_e__Union_,
      symlink : Symlink_e__Struct_ do

      # Nested Type Symlink_e__Struct_
      @[Extern]
      record Symlink_e__Struct_,
  ...
  record PRJ_PLACEHOLDER_INFO,
    ...
    ea_information : EaInformation_e__Struct_,
    security_information : SecurityInformation_e__Struct_,
    streams_information : StreamsInformation_e__Struct_,
    ...
    @[Extern]
    record StreamsInformation_e__Struct_,
    ...
    @[Extern]
    record EaInformation_e__Struct_,
    ...
    @[Extern]
    record SecurityInformation_e__Struct_,
  ...
  record PRJ_NOTIFICATION_PARAMETERS,
    post_create : PostCreate_e__Struct_,
    file_renamed : FileRenamed_e__Struct_,
    file_deleted_on_handle_close : FileDeletedOnHandleClose_e__Struct_ do

    # Nested Type FileRenamed_e__Struct_
    @[Extern]
    record FileRenamed_e__Struct_,
      notification_mask : Win32cr::Storage::ProjectedFileSystem::PRJ_NOTIFY_TYPES


    # Nested Type FileDeletedOnHandleClose_e__Struct_
    @[Extern]
    record FileDeletedOnHandleClose_e__Struct_,
      is_file_modified : Win32cr::Foundation::BOOLEAN


    # Nested Type PostCreate_e__Struct_
    @[Extern]
    record PostCreate_e__Struct_,
      notification_mask : Win32cr::Storage::ProjectedFileSystem::PRJ_NOTIFY_TYPES
  ...
  record PRJ_COMPLETE_COMMAND_EXTENDED_PARAMETERS,
    ...
    @[Extern(union: true)]
    record Anonymous_e__Union_,
      notification : Notification_e__Struct_,
      enumeration : Enumeration_e__Struct_ do

      # Nested Type Enumeration_e__Struct_
      @[Extern]
      record Enumeration_e__Struct_,
      ...
      @[Extern]
      record Notification_e__Struct_,
        notification_mask : Win32cr::Storage::ProjectedFileSystem::PRJ_NOTIFY_TYPES
