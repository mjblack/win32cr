...
module Win32cr::Storage::ProjectedFileSystem
  ...
  @[Extern]
  record PRJ_EXTENDED_INFO,
    info_type : Win32cr::Storage::ProjectedFileSystem::PRJ_EXT_INFO_TYPE,
    ...
    record Anonymous_e__Union,
      symlink : Symlink_e__Struct do

      # Nested Type Symlink_e__Struct
      @[Extern]
      record Symlink_e__Struct,
  ...
  @[Extern]
  record PRJ_NOTIFICATION_MAPPING,
    notification_bit_mask : Win32cr::Storage::ProjectedFileSystem::PRJ_NOTIFY_TYPES,
    notification_root : Win32cr::Foundation::PWSTR

  @[Extern]
  record PRJ_STARTVIRTUALIZING_OPTIONS,
    flags : Win32cr::Storage::ProjectedFileSystem::PRJ_STARTVIRTUALIZING_FLAGS,
    pool_thread_count : UInt32,
    concurrent_thread_count : UInt32,
    notification_mappings : Win32cr::Storage::ProjectedFileSystem::PRJ_NOTIFICATION_MAPPING*,
    notification_mappings_count : UInt32

  @[Extern]
  record PRJ_VIRTUALIZATION_INSTANCE_INFO,
    instance_id : LibC::GUID,
    write_alignment : UInt32

  @[Extern]
  record PRJ_PLACEHOLDER_VERSION_INFO,
    provider_id : UInt8[128],
    content_id : UInt8[128]

  @[Extern]
  record PRJ_FILE_BASIC_INFO,
    is_directory : Win32cr::Foundation::BOOLEAN,
    file_size : Int64,
  ...
  @[Extern]
  record PRJ_PLACEHOLDER_INFO,
    file_basic_info : Win32cr::Storage::ProjectedFileSystem::PRJ_FILE_BASIC_INFO,
    ea_information : EaInformation_e__Struct,
    security_information : SecurityInformation_e__Struct,
    streams_information : StreamsInformation_e__Struct,
    version_info : Win32cr::Storage::ProjectedFileSystem::PRJ_PLACEHOLDER_VERSION_INFO,
    variable_data : UInt8* do

    # Nested Type StreamsInformation_e__Struct
    @[Extern]
    record StreamsInformation_e__Struct,
      streams_info_buffer_size : UInt32,
      offset_to_first_stream_info : UInt32


    # Nested Type EaInformation_e__Struct
    @[Extern]
    record EaInformation_e__Struct,
      ea_buffer_size : UInt32,
      offset_to_first_ea : UInt32


    # Nested Type SecurityInformation_e__Struct
    @[Extern]
    record SecurityInformation_e__Struct,
  ...
  @[Extern]
  record PRJ_CALLBACK_DATA,
    size : UInt32,
    flags : Win32cr::Storage::ProjectedFileSystem::PRJ_CALLBACK_DATA_FLAGS,
    namespace_virtualization_context : Win32cr::Storage::ProjectedFileSystem::PRJ_NAMESPACE_VIRTUALIZATION_CONTEXT,
    command_id : Int32,
    file_id : LibC::GUID,
    data_stream_id : LibC::GUID,
    file_path_name : Win32cr::Foundation::PWSTR,
    version_info : Win32cr::Storage::ProjectedFileSystem::PRJ_PLACEHOLDER_VERSION_INFO*,
    triggering_process_id : UInt32,
    triggering_process_image_file_name : Win32cr::Foundation::PWSTR,
    instance_context : Void*

  @[Extern(union: true)]
  record PRJ_NOTIFICATION_PARAMETERS,
    post_create : PostCreate_e__Struct,
    file_renamed : FileRenamed_e__Struct,
    file_deleted_on_handle_close : FileDeletedOnHandleClose_e__Struct do

    # Nested Type FileRenamed_e__Struct
    @[Extern]
    record FileRenamed_e__Struct,
      notification_mask : Win32cr::Storage::ProjectedFileSystem::PRJ_NOTIFY_TYPES


    # Nested Type FileDeletedOnHandleClose_e__Struct
    @[Extern]
    record FileDeletedOnHandleClose_e__Struct,
      is_file_modified : Win32cr::Foundation::BOOLEAN


    # Nested Type PostCreate_e__Struct
    @[Extern]
    record PostCreate_e__Struct,
      notification_mask : Win32cr::Storage::ProjectedFileSystem::PRJ_NOTIFY_TYPES

  end

  @[Extern]
  record PRJ_CALLBACKS,
    start_directory_enumeration_callback : Win32cr::Storage::ProjectedFileSystem::PRJ_START_DIRECTORY_ENUMERATION_CB,
    end_directory_enumeration_callback : Win32cr::Storage::ProjectedFileSystem::PRJ_END_DIRECTORY_ENUMERATION_CB,
    get_directory_enumeration_callback : Win32cr::Storage::ProjectedFileSystem::PRJ_GET_DIRECTORY_ENUMERATION_CB,
    get_placeholder_info_callback : Win32cr::Storage::ProjectedFileSystem::PRJ_GET_PLACEHOLDER_INFO_CB,
    get_file_data_callback : Win32cr::Storage::ProjectedFileSystem::PRJ_GET_FILE_DATA_CB,
    query_file_name_callback : Win32cr::Storage::ProjectedFileSystem::PRJ_QUERY_FILE_NAME_CB,
    notification_callback : Win32cr::Storage::ProjectedFileSystem::PRJ_NOTIFICATION_CB,
    cancel_command_callback : Win32cr::Storage::ProjectedFileSystem::PRJ_CANCEL_COMMAND_CB

  @[Extern]
  record PRJ_COMPLETE_COMMAND_EXTENDED_PARAMETERS,
    command_type : Win32cr::Storage::ProjectedFileSystem::PRJ_COMPLETE_COMMAND_TYPE,
    anonymous : Anonymous_e__Union do

    # Nested Type Anonymous_e__Union
    @[Extern(union: true)]
    record Anonymous_e__Union,
      notification : Notification_e__Struct,
      enumeration : Enumeration_e__Struct do

      # Nested Type Enumeration_e__Struct
      @[Extern]
      record Enumeration_e__Struct,
        dir_entry_buffer_handle : Win32cr::Storage::ProjectedFileSystem::PRJ_DIR_ENTRY_BUFFER_HANDLE


      # Nested Type Notification_e__Struct
      @[Extern]
      record Notification_e__Struct,
        notification_mask : Win32cr::Storage::ProjectedFileSystem::PRJ_NOTIFY_TYPES
