...
module Win32cr::Storage::Vhd
  ...
  record OPEN_VIRTUAL_DISK_PARAMETERS,
    ...
    record Anonymous_e__Union,
      version1 : Version1_e__Struct,
      version2 : Version2_e__Struct,
      version3 : Version3_e__Struct do

      # Nested Type Version3_e__Struct
      @[Extern]
      record Version3_e__Struct,
      ...
      # Nested Type Version1_e__Struct
      @[Extern]
      record Version1_e__Struct,
        rw_depth : UInt32


      # Nested Type Version2_e__Struct
      @[Extern]
      record Version2_e__Struct,
        get_info_only : Win32cr::Foundation::BOOL,
        read_only : Win32cr::Foundation::BOOL,
        resiliency_guid : LibC::GUID
  ...
  record CREATE_VIRTUAL_DISK_PARAMETERS,
    ...
    record Anonymous_e__Union,
      version1 : Version1_e__Struct,
      version2 : Version2_e__Struct,
      version3 : Version3_e__Struct,
      version4 : Version4_e__Struct do

      # Nested Type Version4_e__Struct
      @[Extern]
      record Version4_e__Struct,
        unique_id : LibC::GUID,
        maximum_size : UInt64,
  ...
  record ATTACH_VIRTUAL_DISK_PARAMETERS,
    ...
    record Anonymous_e__Union,
      version1 : Version1_e__Struct,
      version2 : Version2_e__Struct do
  ...
  record GET_VIRTUAL_DISK_INFO,
    ...
    record Anonymous_e__Union,
      ...
      parent_location : ParentLocation_e__Struct,
      ...
      # Nested Type ChangeTrackingState_e__Struct
      @[Extern]
      record ChangeTrackingState_e__Struct,
        enabled : Win32cr::Foundation::BOOL,
        newer_changes : Win32cr::Foundation::BOOL,
        most_recent_id : UInt16*


      # Nested Type ParentLocation_e__Struct
      @[Extern]
      record ParentLocation_e__Struct,
  ...
  record SET_VIRTUAL_DISK_INFO,
    ...
    record Anonymous_e__Union,
      ...
      parent_path_with_depth_info : ParentPathWithDepthInfo_e__Struct,
      vhd_physical_sector_size : UInt32,
      virtual_disk_id : LibC::GUID,
      change_tracking_enabled : Win32cr::Foundation::BOOL,
      parent_locator : ParentLocator_e__Struct do

      # Nested Type ParentPathWithDepthInfo_e__Struct
      @[Extern]
      record ParentPathWithDepthInfo_e__Struct,
        child_depth : UInt32,
        parent_file_path : Win32cr::Foundation::PWSTR


      # Nested Type ParentLocator_e__Struct
      @[Extern]
      record ParentLocator_e__Struct,
  ...
  record COMPACT_VIRTUAL_DISK_PARAMETERS,
    ...
    @[Extern(union: true)]
    record Anonymous_e__Union,
      version1 : Version1_e__Struct do
  ...
  record MODIFY_VHDSET_PARAMETERS,
    ...
    @[Extern(union: true)]
    record Anonymous_e__Union,
      snapshot_path : SnapshotPath_e__Struct,
      snapshot_id : LibC::GUID,
      default_file_path : Win32cr::Foundation::PWSTR do

      # Nested Type SnapshotPath_e__Struct
      @[Extern]
      record SnapshotPath_e__Struct,
        snapshot_id : LibC::GUID,
