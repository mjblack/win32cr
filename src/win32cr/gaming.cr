...
module Win32cr::Gaming
  ...
  @[Link("api-ms-win-gaming-expandedresources-l1-1-0.dll")]
  @[Link("api-ms-win-gaming-deviceinformation-l1-1-0.dll")]
  @[Link("api-ms-win-gaming-tcui-l1-1-0.dll")]
  @[Link("api-ms-win-gaming-tcui-l1-1-1.dll")]
  @[Link("api-ms-win-gaming-tcui-l1-1-2.dll")]
  @[Link("api-ms-win-gaming-tcui-l1-1-3.dll")]
  @[Link("api-ms-win-gaming-tcui-l1-1-4.dll")]
  {% if !flag?(:docs) %}
  lib C
    # :nodoc:
