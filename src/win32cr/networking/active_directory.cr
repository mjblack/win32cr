...
module Win32cr::Networking::ActiveDirectory
  ...
  record IDirectorySearchVtbl,
    ...
    execute_search : Proc(IDirectorySearch*, Win32cr::Foundation::PWSTR, Win32cr::Foundation::PWSTR*, UInt32, LibC::IntPtrT*, Win32cr::Foundation::HRESULT),
    abandon_search : Proc(IDirectorySearch*, LibC::IntPtrT, Win32cr::Foundation::HRESULT),
    get_first_row : Proc(IDirectorySearch*, LibC::IntPtrT, Win32cr::Foundation::HRESULT),
    get_next_row : Proc(IDirectorySearch*, LibC::IntPtrT, Win32cr::Foundation::HRESULT),
    get_previous_row : Proc(IDirectorySearch*, LibC::IntPtrT, Win32cr::Foundation::HRESULT),
    get_next_column_name : Proc(IDirectorySearch*, LibC::IntPtrT, Win32cr::Foundation::PWSTR*, Win32cr::Foundation::HRESULT),
    get_column : Proc(IDirectorySearch*, LibC::IntPtrT, Win32cr::Foundation::PWSTR, Win32cr::Networking::ActiveDirectory::Ads_search_column*, Win32cr::Foundation::HRESULT),
    free_column : Proc(IDirectorySearch*, Win32cr::Networking::ActiveDirectory::Ads_search_column*, Win32cr::Foundation::HRESULT),
    close_search_handle : Proc(IDirectorySearch*, LibC::IntPtrT, Win32cr::Foundation::HRESULT)
  ...
  record IDirectorySearch, lpVtbl : IDirectorySearchVtbl* do
    ...
    def execute_search(this : IDirectorySearch*, pszSearchFilter : Win32cr::Foundation::PWSTR, pAttributeNames : Win32cr::Foundation::PWSTR*, dwNumberAttributes : UInt32, phSearchResult : LibC::IntPtrT*) : Win32cr::Foundation::HRESULT
      @lpVtbl.try &.value.execute_search.call(this, pszSearchFilter, pAttributeNames, dwNumberAttributes, phSearchResult)
    end
    def abandon_search(this : IDirectorySearch*, phSearchResult : LibC::IntPtrT) : Win32cr::Foundation::HRESULT
      @lpVtbl.try &.value.abandon_search.call(this, phSearchResult)
    end
    def get_first_row(this : IDirectorySearch*, hSearchResult : LibC::IntPtrT) : Win32cr::Foundation::HRESULT
      @lpVtbl.try &.value.get_first_row.call(this, hSearchResult)
    end
    def get_next_row(this : IDirectorySearch*, hSearchResult : LibC::IntPtrT) : Win32cr::Foundation::HRESULT
      @lpVtbl.try &.value.get_next_row.call(this, hSearchResult)
    end
    def get_previous_row(this : IDirectorySearch*, hSearchResult : LibC::IntPtrT) : Win32cr::Foundation::HRESULT
      @lpVtbl.try &.value.get_previous_row.call(this, hSearchResult)
    end
    def get_next_column_name(this : IDirectorySearch*, hSearchHandle : LibC::IntPtrT, ppszColumnName : Win32cr::Foundation::PWSTR*) : Win32cr::Foundation::HRESULT
      @lpVtbl.try &.value.get_next_column_name.call(this, hSearchHandle, ppszColumnName)
    end
    def get_column(this : IDirectorySearch*, hSearchResult : LibC::IntPtrT, szColumnName : Win32cr::Foundation::PWSTR, pSearchColumn : Win32cr::Networking::ActiveDirectory::Ads_search_column*) : Win32cr::Foundation::HRESULT
    ...
    def close_search_handle(this : IDirectorySearch*, hSearchResult : LibC::IntPtrT) : Win32cr::Foundation::HRESULT
