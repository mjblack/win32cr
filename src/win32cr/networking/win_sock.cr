...
module Win32cr::Networking::WinSock
  ...
  @[Extern]
  record IN_ADDR,
    s_un : S_un_e__Union do

    # Nested Type S_un_e__Union
    @[Extern(union: true)]
    record S_un_e__Union,
      s_un_b : S_un_b_e__Struct,
      s_un_w : S_un_w_e__Struct,
      s_addr : UInt32 do

      # Nested Type S_un_w_e__Struct
      @[Extern]
      record S_un_w_e__Struct,
        s_w1 : UInt16,
        s_w2 : UInt16


      # Nested Type S_un_b_e__Struct
      @[Extern]
      record S_un_b_e__Struct,
        s_b1 : UInt8,
        s_b2 : UInt8,
        s_b3 : UInt8,
        s_b4 : UInt8
  ...
  record WSACOMPLETION,
    ...
    record Parameters_e__Union,
      window_message : WindowMessage_e__Struct,
      event : Event_e__Struct,
      apc : Apc_e__Struct,
      port : Port_e__Struct do

      # Nested Type Port_e__Struct
      @[Extern]
      record Port_e__Struct,
      ...
      # Nested Type WindowMessage_e__Struct
      @[Extern]
      record WindowMessage_e__Struct,
  ...
  record WINDOWS_IAS_SET,
    ...
    irdaAttribute : Irdaattribute_e__union do

    # Nested Type Irdaattribute_e__union
    @[Extern(union: true)]
    record Irdaattribute_e__union,
      irdaAttribInt : Int32,
      irdaAttribOctetSeq : Irdaattriboctetseq_e__struct,
      irdaAttribUsrStr : Irdaattribusrstr_e__struct do

      # Nested Type Irdaattriboctetseq_e__struct
      @[Extern]
      record Irdaattriboctetseq_e__struct,
        len : UInt16,
        octet_seq : UInt8[1024]


      # Nested Type Irdaattribusrstr_e__struct
      @[Extern]
      record Irdaattribusrstr_e__struct,
        len : UInt8,
        char_set : UInt8,
        usr_str : UInt8[256]
  ...
  record AAL_PARAMETERS_IE,
    ...
    aal_specific_parameters : AALSpecificParameters_e__Union do

    # Nested Type AALSpecificParameters_e__Union
    @[Extern(union: true)]
    record AALSpecificParameters_e__Union,
  ...
  record NLA_BLOB,
    ...
    record Data_e__union,
      ...
      interfaceData : Interfacedata_e__struct,
      locationData : Locationdata_e__struct,
      connectivity : Connectivity_e__struct,
      ics : ICS_e__Struct do

      # Nested Type ICS_e__Struct
      @[Extern]
      record ICS_e__Struct,
        remote : Remote_e__struct do

        # Nested Type Remote_e__struct
        @[Extern]
        record Remote_e__struct,
          speed : UInt32,
          type__ : UInt32,
          state : UInt32,
      ...
      # Nested Type Locationdata_e__struct
      @[Extern]
      record Locationdata_e__struct,
        information : Win32cr::Foundation::CHAR*


      # Nested Type Connectivity_e__struct
      @[Extern]
      record Connectivity_e__struct,
        type__ : Win32cr::Networking::WinSock::NLA_CONNECTIVITY_TYPE,
        internet : Win32cr::Networking::WinSock::NLA_INTERNET


      # Nested Type Interfacedata_e__struct
      @[Extern]
      record Interfacedata_e__struct,
        dwType : UInt32,
        dwSpeed : UInt32,
    ...
    # Nested Type Header_e__struct
    @[Extern]
    record Header_e__struct,
  ...
  record RIO_NOTIFICATION_COMPLETION,
    ...
    record Anonymous_e__Union,
      event : Event_e__Struct,
      iocp : Iocp_e__Struct do

      # Nested Type Iocp_e__Struct
      @[Extern]
      record Iocp_e__Struct,
