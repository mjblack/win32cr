...
module Win32cr::Networking::Ldap
  ...
  record Ldap,
    ...
    # Nested Type Ld_sb_e__struct
    @[Extern]
    record Ld_sb_e__struct,
      sb_sd : LibC::UIntPtrT,
      reserved1 : UInt8[41],
  ...
  record Ldapmodw,
    ...
    mod_vals : Mod_vals_e__union do

    # Nested Type Mod_vals_e__union
    @[Extern(union: true)]
    record Mod_vals_e__union,
