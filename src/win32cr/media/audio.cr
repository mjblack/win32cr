...
module Win32cr::Media::Audio
  ...
  @[Flags]
  enum SND_FLAGS : UInt32
    SND_APPLICATION = 128_u32
    SND_ALIAS = 65536_u32
    SND_ALIAS_ID = 1114112_u32
    SND_FILENAME = 131072_u32
    SND_RESOURCE = 262148_u32
    SND_ASYNC = 1_u32
    SND_NODEFAULT = 2_u32
    SND_LOOP = 8_u32
    SND_MEMORY = 4_u32
    ...
    SND_NOWAIT = 8192_u32
    SND_PURGE = 64_u32
    SND_SENTRY = 524288_u32
    SND_SYNC = 0_u32
    SND_SYSTEM = 2097152_u32
  end
  ...
  enum AUDIO_SYSTEMEFFECTS_PROPERTYSTORE_TYPE
  ...
  @[Link("winmm.dll")]
  @[Link("mmdevapi.dll")]
  @[Link("windows.media.mediacontrol.dll")]
  @[Link("msacm32.dll")]
  {% if !flag?(:docs) %}
  lib C
    # :nodoc:
