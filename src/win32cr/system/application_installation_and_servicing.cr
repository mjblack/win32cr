...
module Win32cr::System::ApplicationInstallationAndServicing
  ...
  record PM_ENUM_FILTER,
    filter_type : Int32,
    filter_parameter : FilterParameter_e__Union do

    # Nested Type FilterParameter_e__Union
    @[Extern(union: true)]
    record FilterParameter_e__Union,
      dummy : Int32,
      ...
      app_task_type : Win32cr::System::ApplicationInstallationAndServicing::Tagapptasktype,
