...
module Win32cr::System::Com::StructuredStorage
  ...
  struct STATPROPSTG
    ...
    property propid : UInt32
    property vt : Win32cr::System::Com::VARENUM
    def initialize(@lpwstrName : Win32cr::Foundation::PWSTR, @propid : UInt32, @vt : Win32cr::System::Com::VARENUM)
    end
  end
  ...
  struct PROPBAG2
    ...
    property clsid : LibC::GUID
    def initialize(@dwType : UInt32, @vt : Win32cr::System::Com::VARENUM, @cfType : UInt16, @dwHint : UInt32, @pstrName : Win32cr::Foundation::PWSTR, @clsid : LibC::GUID)
    end
  end
