...
module Win32cr::System::Kernel
  ...
  record SLIST_HEADER,
    ...
    header_arm64 : HeaderArm64_e__Struct do
    ...
    # Nested Type HeaderArm64_e__Struct
    @[Extern]
    record HeaderArm64_e__Struct,
      _bitfield1 : UInt64,
      _bitfield2 : UInt64
  ...
  record SLIST_HEADER,
    anonymous : Anonymous_e__Struct,
    header_x64 : HeaderX64_e__Struct do
    ...
    # Nested Type HeaderX64_e__Struct
    @[Extern]
    record HeaderX64_e__Struct,
      _bitfield1 : UInt64,
      _bitfield2 : UInt64
