...
module Win32cr::System::Power
  ...
  @[Link("kernel32")]
  lib C
    fun CallNtPowerInformation(information_level : Win32cr::System::Power::POWER_INFORMATION_LEVEL, input_buffer : Void*, input_buffer_length : UInt32, output_buffer : Void*, output_buffer_length : UInt32) : Int32
