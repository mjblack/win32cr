...
module Win32cr::System::SystemInformation
  ...
  record SYSTEM_LOGICAL_PROCESSOR_INFORMATION,
    ...
    @[Extern(union: true)]
    record Anonymous_e__Union,
      processor_core : ProcessorCore_e__Struct,
      numa_node : NumaNode_e__Struct,
      cache : Win32cr::System::SystemInformation::CACHE_DESCRIPTOR,
      reserved : UInt64[2] do

      # Nested Type ProcessorCore_e__Struct
      @[Extern]
      record ProcessorCore_e__Struct,
        flags : UInt8


      # Nested Type NumaNode_e__Struct
      @[Extern]
      record NumaNode_e__Struct,
        node_number : UInt32
  ...
  record SYSTEM_CPU_SET_INFORMATION,
    ...
    @[Extern(union: true)]
    record Anonymous_e__Union,
      cpu_set : CpuSet_e__Struct do

      # Nested Type CpuSet_e__Struct
      @[Extern]
      record CpuSet_e__Struct,
        id : UInt32,
        group : UInt16,
  ...
  lib C
    ...
    fun GetSystemWow64Directory2A(lpBuffer : UInt8*, uSize : UInt32, image_file_machine_type : UInt16) : UInt32

    fun GetSystemWow64Directory2W(lpBuffer : UInt16*, uSize : UInt32, image_file_machine_type : UInt16) : UInt32

    fun IsWow64GuestMachineSupported(wow_guest_machine : UInt16, machine_is_supported : Win32cr::Foundation::BOOL*) : Win32cr::Foundation::HRESULT
