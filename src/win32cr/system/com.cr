...
module Win32cr::System::Com
  ...
  CRT_INTERNAL_COMBASE_SYMBOL_PREFIX = "_"
  ...
  record Uclsspec,
    tyspec : UInt32,
    tagged_union : Tagged_union_e__struct do

    # Nested Type Tagged_union_e__struct
    @[Extern(union: true)]
    record Tagged_union_e__struct,
      clsid : LibC::GUID,
      ...
      by_name : ByName_e__Struct,
      by_object_id : ByObjectId_e__Struct do

      # Nested Type ByObjectId_e__Struct
      @[Extern]
      record ByObjectId_e__Struct,
        object_id : LibC::GUID,
        policy_id : LibC::GUID


      # Nested Type ByName_e__Struct
      @[Extern]
      record ByName_e__Struct,
  ...
  record Userstgmedium,
    ...
    # Nested Type STGMEDIUM_UNION
    @[Extern]
    record STGMEDIUM_UNION,
      tymed : UInt32,
      u : U_e__struct do
  ...
  record IRunningObjectTableVtbl,
    ...
    register : Proc(IRunningObjectTable*, UInt32, Void*, Void*, UInt32*, Win32cr::Foundation::HRESULT),
  ...
  record IRunningObjectTable, lpVtbl : IRunningObjectTableVtbl* do
    ...
    def register(this : IRunningObjectTable*, grfFlags : UInt32, punkObject : Void*, pmkObjectName : Void*, pdwRegister : UInt32*) : Win32cr::Foundation::HRESULT
