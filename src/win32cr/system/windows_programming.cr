...
module Win32cr::System::WindowsProgramming
  ...
  def signalObjectAndWait(hObjectToSignal : Win32cr::Foundation::HANDLE, hObjectToWaitOn : Win32cr::Foundation::HANDLE, dwMilliseconds : UInt32, bAlertable : Win32cr::Foundation::BOOL) : Win32cr::Foundation::WIN32_ERROR
    {% if !flag?(:docs) %}
...
{% end %}
  ...
  @[Link("ntdll.dll")]
  @[Link("kernel32.dll")]
  @[Link("api-ms-win-core-realtime-l1-1-1.dll")]
  @[Link("api-ms-win-core-realtime-l1-1-2.dll")]
  @[Link("advapi32.dll")]
  @[Link("api-ms-win-core-backgroundtask-l1-1-0.dll")]
  @[Link("api-ms-win-core-featurestaging-l1-1-0.dll")]
  @[Link("api-ms-win-core-featurestaging-l1-1-1.dll")]
  @[Link("dciman32.dll")]
  @[Link("api-ms-win-dx-d3dkmt-l1-1-0.dll")]
  @[Link("advpack.dll")]
  @[Link("user32.dll")]
  @[Link("apphelp.dll")]
  @[Link("wldp.dll")]
  ...
  lib C
    ...
    # :nodoc:
    fun SignalObjectAndWait(hObjectToSignal : Win32cr::Foundation::HANDLE, hObjectToWaitOn : Win32cr::Foundation::HANDLE, dwMilliseconds : UInt32, bAlertable : Win32cr::Foundation::BOOL) : Win32cr::Foundation::WIN32_ERROR
