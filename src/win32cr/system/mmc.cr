...
module Win32cr::System::Mmc
  ...
  @[Extern]
  record MMC_SNAPIN_PROPERTY,
    pszPropName : Win32cr::Foundation::PWSTR,
    varValue : Win32cr::System::Com::VARIANT,
    eAction : Win32cr::System::Mmc::MMC_PROPERTY_ACTION
  ...
  record MMCBUTTON,
    ...
    fsState : UInt8,
    fsType : UInt8,
    lpButtonText : Win32cr::Foundation::PWSTR,
    lpTooltipText : Win32cr::Foundation::PWSTR

  @[Extern]
  record RESULTDATAITEM,
    mask : UInt32,
    bScopeItem : Win32cr::Foundation::BOOL,
    itemID : LibC::IntPtrT,
    nIndex : Int32,
    nCol : Int32,
    str : Win32cr::Foundation::PWSTR,
    nImage : Int32,
    nState : UInt32,
  ...
  @[Extern]
  record RESULTFINDINFO,
    psz : Win32cr::Foundation::PWSTR,
    nStart : Int32,
    dwOptions : UInt32

  @[Extern]
  record SCOPEDATAITEM,
    mask : UInt32,
    displayname : Win32cr::Foundation::PWSTR,
    nImage : Int32,
    nOpenImage : Int32,
    nState : UInt32,
    cChildren : Int32,
    lParam : Win32cr::Foundation::LPARAM,
    relativeID : LibC::IntPtrT,
    id : LibC::IntPtrT

  @[Extern]
  record CONTEXTMENUITEM,
    strName : Win32cr::Foundation::PWSTR,
    strStatusBarText : Win32cr::Foundation::PWSTR,
    lCommandID : Int32,
  ...
  @[Extern]
  record MENUBUTTONDATA,
    idCommand : Int32,
    x : Int32,
    y : Int32

  @[Extern]
  record MMC_FILTERDATA,
    pszText : Win32cr::Foundation::PWSTR,
    cchTextMax : Int32,
    lValue : Int32

  @[Extern]
  record MMC_RESTORE_VIEW,
    dwSize : UInt32,
    cookie : LibC::IntPtrT,
    pViewType : Win32cr::Foundation::PWSTR,
    lViewOptions : Int32

  @[Extern]
  record MMC_EXPANDSYNC_STRUCT,
    bHandled : Win32cr::Foundation::BOOL,
    bExpanding : Win32cr::Foundation::BOOL,
    hItem : LibC::IntPtrT

  @[Extern]
  record MMC_VISIBLE_COLUMNS,
    nVisibleColumns : Int32,
    rgVisibleCols : Int32*

  @[Extern]
  record SMMCDataObjects,
    count : UInt32,
    lpDataObject : Void**

  @[Extern]
  record SMMCObjectTypes,
    count : UInt32,
    guid : LibC::GUID*
  ...
  @[Extern]
  record MMC_TASK_DISPLAY_SYMBOL,
    szFontFamilyName : Win32cr::Foundation::PWSTR,
    szURLtoEOT : Win32cr::Foundation::PWSTR,
    szSymbolString : Win32cr::Foundation::PWSTR

  @[Extern]
  record MMC_TASK_DISPLAY_BITMAP,
    szMouseOverBitmap : Win32cr::Foundation::PWSTR,
    szMouseOffBitmap : Win32cr::Foundation::PWSTR

  @[Extern]
  record MMC_TASK_DISPLAY_OBJECT,
    eDisplayType : Win32cr::System::Mmc::MMC_TASK_DISPLAY_TYPE,
    anonymous : Anonymous_e__Union do

    # Nested Type Anonymous_e__Union
    @[Extern(union: true)]
    record Anonymous_e__Union,
      uBitmap : Win32cr::System::Mmc::MMC_TASK_DISPLAY_BITMAP,
      uSymbol : Win32cr::System::Mmc::MMC_TASK_DISPLAY_SYMBOL

  end

  @[Extern]
  record MMC_TASK,
    sDisplayObject : Win32cr::System::Mmc::MMC_TASK_DISPLAY_OBJECT,
    szText : Win32cr::Foundation::PWSTR,
    szHelpString : Win32cr::Foundation::PWSTR,
    eActionType : Win32cr::System::Mmc::MMC_ACTION_TYPE,
    anonymous : Anonymous_e__Union do

    # Nested Type Anonymous_e__Union
    @[Extern(union: true)]
    record Anonymous_e__Union,
      nCommandID : LibC::IntPtrT,
      szActionURL : Win32cr::Foundation::PWSTR,
      szScript : Win32cr::Foundation::PWSTR

  end

  @[Extern]
  record MMC_LISTPAD_INFO,
    szTitle : Win32cr::Foundation::PWSTR,
    szButtonText : Win32cr::Foundation::PWSTR,
    nCommandID : LibC::IntPtrT

  @[Extern]
  record MMC_COLUMN_DATA,
    nColIndex : Int32,
    dwFlags : UInt32,
    nWidth : Int32,
    ulReserved : LibC::UIntPtrT

  @[Extern]
  record MMC_COLUMN_SET_DATA,
    cbSize : Int32,
    nNumCols : Int32,
    pColData : Win32cr::System::Mmc::MMC_COLUMN_DATA*

  @[Extern]
  record MMC_SORT_DATA,
    nColIndex : Int32,
    dwSortOptions : UInt32,
    ulReserved : LibC::UIntPtrT

  @[Extern]
  record MMC_SORT_SET_DATA,
    cbSize : Int32,
    nNumItems : Int32,
    pSortData : Win32cr::System::Mmc::MMC_SORT_DATA*

  @[Extern]
  record RDITEMHDR,
    dwFlags : UInt32,
    cookie : LibC::IntPtrT,
    lpReserved : Win32cr::Foundation::LPARAM
  ...
  record RDCOMPARE,
    ...
    dwFlags : UInt32,
    nColumn : Int32,
    lUserParam : Win32cr::Foundation::LPARAM,
    prdch1 : Win32cr::System::Mmc::RDITEMHDR*,
    prdch2 : Win32cr::System::Mmc::RDITEMHDR*

  @[Extern]
  record RESULT_VIEW_TYPE_INFO,
    pstrPersistableViewDescription : Win32cr::Foundation::PWSTR,
    eViewType : Win32cr::System::Mmc::MMC_VIEW_TYPE,
    ...
    record Anonymous_e__Union,
      ...
      record Anonymous1_e__Struct,
        ...
        pstrURL : Win32cr::Foundation::PWSTR
  ...
  record CONTEXTMENUITEM2,
    ...
    fFlags : Int32,
    fSpecialFlags : Int32,
    strLanguageIndependentName : Win32cr::Foundation::PWSTR

  @[Extern]
  record MMC_EXT_VIEW_DATA,
    viewID : LibC::GUID,
    pszURL : Win32cr::Foundation::PWSTR,
    pszViewTitle : Win32cr::Foundation::PWSTR,
    pszTooltipText : Win32cr::Foundation::PWSTR,
    bReplacesDefaultView : Win32cr::Foundation::BOOL
  ...
  @[Extern]
  #@[Com("f7889da9-4a02-4837-bf89-1a6f2a021010")]
  ...
  @[Extern]
  #@[Com("a50fa2e5-7e61-45eb-a8d4-9a07b3e851a8")]
  ...
  @[Extern]
  record ApplicationVtbl,
    query_interface : Proc(Application*, LibC::GUID*, Void**, Win32cr::Foundation::HRESULT),
    add_ref : Proc(Application*, UInt32),
    release : Proc(Application*, UInt32),
    get_type_info_count : Proc(Application*, UInt32*, Win32cr::Foundation::HRESULT),
    get_type_info : Proc(Application*, UInt32, UInt32, Void**, Win32cr::Foundation::HRESULT),
    get_i_ds_of_names : Proc(Application*, LibC::GUID*, Win32cr::Foundation::PWSTR*, UInt32, UInt32, Int32*, Win32cr::Foundation::HRESULT),
    invoke_1 : Proc(Application*, Int32, LibC::GUID*, UInt32, UInt16, Win32cr::System::Com::DISPPARAMS*, Win32cr::System::Com::VARIANT*, Win32cr::System::Com::EXCEPINFO*, UInt32*, Win32cr::Foundation::HRESULT),
    help : Proc(Application*, Void),
    quit : Proc(Application*, Void),
    get_Document : Proc(Application*, Void**, Win32cr::Foundation::HRESULT),
    load : Proc(Application*, Win32cr::Foundation::BSTR, Win32cr::Foundation::HRESULT),
    get_Frame : Proc(Application*, Void**, Win32cr::Foundation::HRESULT),
    get_Visible : Proc(Application*, Win32cr::Foundation::BOOL*, Win32cr::Foundation::HRESULT),
    show : Proc(Application*, Win32cr::Foundation::HRESULT),
    hide : Proc(Application*, Win32cr::Foundation::HRESULT),
    get_UserControl : Proc(Application*, Win32cr::Foundation::BOOL*, Win32cr::Foundation::HRESULT),
    put_UserControl : Proc(Application*, Win32cr::Foundation::BOOL, Win32cr::Foundation::HRESULT),
    get_VersionMajor : Proc(Application*, Int32*, Win32cr::Foundation::HRESULT),
    get_VersionMinor : Proc(Application*, Int32*, Win32cr::Foundation::HRESULT)


  @[Extern]
  #@[Com("a3afb9cc-b653-4741-86ab-f0470ec1384c")]
  record Application, lpVtbl : ApplicationVtbl* do
    ...
    def query_interface(this : Application*, riid : LibC::GUID*, ppvObject : Void**) : Win32cr::Foundation::HRESULT
      @lpVtbl.try &.value.query_interface.call(this, riid, ppvObject)
    end
    def add_ref(this : Application*) : UInt32
      @lpVtbl.try &.value.add_ref.call(this)
    end
    def release(this : Application*) : UInt32
      @lpVtbl.try &.value.release.call(this)
    end
    def get_type_info_count(this : Application*, pctinfo : UInt32*) : Win32cr::Foundation::HRESULT
      @lpVtbl.try &.value.get_type_info_count.call(this, pctinfo)
    end
    def get_type_info(this : Application*, iTInfo : UInt32, lcid : UInt32, ppTInfo : Void**) : Win32cr::Foundation::HRESULT
      @lpVtbl.try &.value.get_type_info.call(this, iTInfo, lcid, ppTInfo)
    end
    def get_i_ds_of_names(this : Application*, riid : LibC::GUID*, rgszNames : Win32cr::Foundation::PWSTR*, cNames : UInt32, lcid : UInt32, rgDispId : Int32*) : Win32cr::Foundation::HRESULT
      @lpVtbl.try &.value.get_i_ds_of_names.call(this, riid, rgszNames, cNames, lcid, rgDispId)
    end
    def invoke_1(this : Application*, dispIdMember : Int32, riid : LibC::GUID*, lcid : UInt32, wFlags : UInt16, pDispParams : Win32cr::System::Com::DISPPARAMS*, pVarResult : Win32cr::System::Com::VARIANT*, pExcepInfo : Win32cr::System::Com::EXCEPINFO*, puArgErr : UInt32*) : Win32cr::Foundation::HRESULT
      @lpVtbl.try &.value.invoke_1.call(this, dispIdMember, riid, lcid, wFlags, pDispParams, pVarResult, pExcepInfo, puArgErr)
    end
    def help(this : Application*) : Void
      @lpVtbl.try &.value.help.call(this)
    end
    def quit(this : Application*) : Void
      @lpVtbl.try &.value.quit.call(this)
    end
    def get_Document(this : Application*, document : Void**) : Win32cr::Foundation::HRESULT
      @lpVtbl.try &.value.get_Document.call(this, document)
    end
    def load(this : Application*, filename : Win32cr::Foundation::BSTR) : Win32cr::Foundation::HRESULT
      @lpVtbl.try &.value.load.call(this, filename)
    end
    def get_Frame(this : Application*, frame : Void**) : Win32cr::Foundation::HRESULT
      @lpVtbl.try &.value.get_Frame.call(this, frame)
    end
    def get_Visible(this : Application*, visible : Win32cr::Foundation::BOOL*) : Win32cr::Foundation::HRESULT
      @lpVtbl.try &.value.get_Visible.call(this, visible)
    end
    def show(this : Application*) : Win32cr::Foundation::HRESULT
      @lpVtbl.try &.value.show.call(this)
    end
    def hide(this : Application*) : Win32cr::Foundation::HRESULT
      @lpVtbl.try &.value.hide.call(this)
    end
    def get_UserControl(this : Application*, user_control : Win32cr::Foundation::BOOL*) : Win32cr::Foundation::HRESULT
      @lpVtbl.try &.value.get_UserControl.call(this, user_control)
    end
    def put_UserControl(this : Application*, user_control : Win32cr::Foundation::BOOL) : Win32cr::Foundation::HRESULT
      @lpVtbl.try &.value.put_UserControl.call(this, user_control)
    end
    def get_VersionMajor(this : Application*, version_major : Int32*) : Win32cr::Foundation::HRESULT
      @lpVtbl.try &.value.get_VersionMajor.call(this, version_major)
    end
    def get_VersionMinor(this : Application*, version_minor : Int32*) : Win32cr::Foundation::HRESULT
  ...
  record AppEventsVtbl,
    ...
    on_quit : Proc(AppEvents*, Void*, Win32cr::Foundation::HRESULT),
    on_document_open : Proc(AppEvents*, Void*, Win32cr::Foundation::BOOL, Win32cr::Foundation::HRESULT),
    on_document_close : Proc(AppEvents*, Void*, Win32cr::Foundation::HRESULT),
    on_snap_in_added : Proc(AppEvents*, Void*, Void*, Win32cr::Foundation::HRESULT),
    on_snap_in_removed : Proc(AppEvents*, Void*, Void*, Win32cr::Foundation::HRESULT),
    on_new_view : Proc(AppEvents*, Void*, Win32cr::Foundation::HRESULT),
    on_view_close : Proc(AppEvents*, Void*, Win32cr::Foundation::HRESULT),
    on_view_change : Proc(AppEvents*, Void*, Void*, Win32cr::Foundation::HRESULT),
    on_selection_change : Proc(AppEvents*, Void*, Void*, Win32cr::Foundation::HRESULT),
    on_context_menu_executed : Proc(AppEvents*, Void*, Win32cr::Foundation::HRESULT),
    on_toolbar_button_clicked : Proc(AppEvents*, Win32cr::Foundation::HRESULT),
    on_list_updated : Proc(AppEvents*, Void*, Win32cr::Foundation::HRESULT)


  @[Extern]
  #@[Com("de46cbdd-53f5-4635-af54-4fe71e923d3f")]
  record AppEvents, lpVtbl : AppEventsVtbl* do
    ...
    def on_quit(this : AppEvents*, application : Void*) : Win32cr::Foundation::HRESULT
      @lpVtbl.try &.value.on_quit.call(this, application)
    end
    def on_document_open(this : AppEvents*, document : Void*, new : Win32cr::Foundation::BOOL) : Win32cr::Foundation::HRESULT
      @lpVtbl.try &.value.on_document_open.call(this, document, new)
    end
    def on_document_close(this : AppEvents*, document : Void*) : Win32cr::Foundation::HRESULT
      @lpVtbl.try &.value.on_document_close.call(this, document)
    end
    def on_snap_in_added(this : AppEvents*, document : Void*, snap_in : Void*) : Win32cr::Foundation::HRESULT
      @lpVtbl.try &.value.on_snap_in_added.call(this, document, snap_in)
    end
    def on_snap_in_removed(this : AppEvents*, document : Void*, snap_in : Void*) : Win32cr::Foundation::HRESULT
      @lpVtbl.try &.value.on_snap_in_removed.call(this, document, snap_in)
    end
    def on_new_view(this : AppEvents*, view : Void*) : Win32cr::Foundation::HRESULT
      @lpVtbl.try &.value.on_new_view.call(this, view)
    end
    def on_view_close(this : AppEvents*, view : Void*) : Win32cr::Foundation::HRESULT
      @lpVtbl.try &.value.on_view_close.call(this, view)
    end
    def on_view_change(this : AppEvents*, view : Void*, new_owner_node : Void*) : Win32cr::Foundation::HRESULT
      @lpVtbl.try &.value.on_view_change.call(this, view, new_owner_node)
    end
    def on_selection_change(this : AppEvents*, view : Void*, new_nodes : Void*) : Win32cr::Foundation::HRESULT
      @lpVtbl.try &.value.on_selection_change.call(this, view, new_nodes)
    end
    def on_context_menu_executed(this : AppEvents*, menu_item : Void*) : Win32cr::Foundation::HRESULT
      @lpVtbl.try &.value.on_context_menu_executed.call(this, menu_item)
    end
    def on_toolbar_button_clicked(this : AppEvents*) : Win32cr::Foundation::HRESULT
      @lpVtbl.try &.value.on_toolbar_button_clicked.call(this)
    end
    def on_list_updated(this : AppEvents*, view : Void*) : Win32cr::Foundation::HRESULT
  ...
  @[Extern]
  #@[Com("fc7a4252-78ac-4532-8c5a-563cfe138863")]
  record AppEvents, lpVtbl : AppEventsVtbl* do
  ...
  @[Extern]
  record EventConnectorVtbl,
    query_interface : Proc(EventConnector*, LibC::GUID*, Void**, Win32cr::Foundation::HRESULT),
    add_ref : Proc(EventConnector*, UInt32),
    release : Proc(EventConnector*, UInt32),
    get_type_info_count : Proc(EventConnector*, UInt32*, Win32cr::Foundation::HRESULT),
    get_type_info : Proc(EventConnector*, UInt32, UInt32, Void**, Win32cr::Foundation::HRESULT),
    get_i_ds_of_names : Proc(EventConnector*, LibC::GUID*, Win32cr::Foundation::PWSTR*, UInt32, UInt32, Int32*, Win32cr::Foundation::HRESULT),
    invoke_1 : Proc(EventConnector*, Int32, LibC::GUID*, UInt32, UInt16, Win32cr::System::Com::DISPPARAMS*, Win32cr::System::Com::VARIANT*, Win32cr::System::Com::EXCEPINFO*, UInt32*, Win32cr::Foundation::HRESULT),
    connect_to : Proc(EventConnector*, Void*, Win32cr::Foundation::HRESULT),
    disconnect : Proc(EventConnector*, Win32cr::Foundation::HRESULT)


  @[Extern]
  #@[Com("c0bccd30-de44-4528-8403-a05a6a1cc8ea")]
  record EventConnector, lpVtbl : EventConnectorVtbl* do
    ...
    def query_interface(this : EventConnector*, riid : LibC::GUID*, ppvObject : Void**) : Win32cr::Foundation::HRESULT
      @lpVtbl.try &.value.query_interface.call(this, riid, ppvObject)
    end
    def add_ref(this : EventConnector*) : UInt32
      @lpVtbl.try &.value.add_ref.call(this)
    end
    def release(this : EventConnector*) : UInt32
      @lpVtbl.try &.value.release.call(this)
    end
    def get_type_info_count(this : EventConnector*, pctinfo : UInt32*) : Win32cr::Foundation::HRESULT
      @lpVtbl.try &.value.get_type_info_count.call(this, pctinfo)
    end
    def get_type_info(this : EventConnector*, iTInfo : UInt32, lcid : UInt32, ppTInfo : Void**) : Win32cr::Foundation::HRESULT
      @lpVtbl.try &.value.get_type_info.call(this, iTInfo, lcid, ppTInfo)
    end
    def get_i_ds_of_names(this : EventConnector*, riid : LibC::GUID*, rgszNames : Win32cr::Foundation::PWSTR*, cNames : UInt32, lcid : UInt32, rgDispId : Int32*) : Win32cr::Foundation::HRESULT
      @lpVtbl.try &.value.get_i_ds_of_names.call(this, riid, rgszNames, cNames, lcid, rgDispId)
    end
    def invoke_1(this : EventConnector*, dispIdMember : Int32, riid : LibC::GUID*, lcid : UInt32, wFlags : UInt16, pDispParams : Win32cr::System::Com::DISPPARAMS*, pVarResult : Win32cr::System::Com::VARIANT*, pExcepInfo : Win32cr::System::Com::EXCEPINFO*, puArgErr : UInt32*) : Win32cr::Foundation::HRESULT
      @lpVtbl.try &.value.invoke_1.call(this, dispIdMember, riid, lcid, wFlags, pDispParams, pVarResult, pExcepInfo, puArgErr)
    end
    def connect_to(this : EventConnector*, application : Void*) : Win32cr::Foundation::HRESULT
      @lpVtbl.try &.value.connect_to.call(this, application)
    end
    def disconnect(this : EventConnector*) : Win32cr::Foundation::HRESULT
  ...
  @[Extern]
  #@[Com("e5e2d970-5bb3-4306-8804-b0968a31c8e6")]
  ...
  @[Extern]
  #@[Com("f81ed800-7839-4447-945d-8e15da59ca55")]
  ...
  @[Extern]
  #@[Com("ebbb48dc-1a3b-4d86-b786-c21b28389012")]
  ...
  record DocumentVtbl,
    ...
    get_Mode : Proc(Document*, Win32cr::System::Mmc::DocumentMode*, Win32cr::Foundation::HRESULT),
    put_Mode : Proc(Document*, Win32cr::System::Mmc::DocumentMode, Win32cr::Foundation::HRESULT),
  ...
  @[Extern]
  #@[Com("225120d6-1e0f-40a3-93fe-1079e6a8017b")]
  record Document, lpVtbl : DocumentVtbl* do
    ...
    def get_Mode(this : Document*, mode : Win32cr::System::Mmc::DocumentMode*) : Win32cr::Foundation::HRESULT
      @lpVtbl.try &.value.get_Mode.call(this, mode)
    end
    def put_Mode(this : Document*, mode : Win32cr::System::Mmc::DocumentMode) : Win32cr::Foundation::HRESULT
  ...
  @[Extern]
  #@[Com("3be910f6-3459-49c6-a1bb-41e6be9df3ea")]
  ...
  @[Extern]
  #@[Com("2ef3de1d-b12a-49d1-92c5-0b00798768f1")]
  ...
  @[Extern]
  #@[Com("ad4d6ca6-912f-409b-a26e-7fd234aef542")]
  ...
  @[Extern]
  #@[Com("82dbea43-8ca4-44bc-a2ca-d18741059ec8")]
  ...
  @[Extern]
  #@[Com("383d4d97-fc44-478b-b139-6323dc48611c")]
  ...
  record ColumnVtbl,
    ...
    set_as_sort_column : Proc(Column*, Win32cr::System::Mmc::ColumnSortOrder, Win32cr::Foundation::HRESULT),
    is_sort_column : Proc(Column*, Win32cr::Foundation::BOOL*, Win32cr::Foundation::HRESULT)


  @[Extern]
  #@[Com("fd1c5f63-2b16-4d06-9ab3-f45350b940ab")]
  record Column, lpVtbl : ColumnVtbl* do
    ...
    def set_as_sort_column(this : Column*, sort_order : Win32cr::System::Mmc::ColumnSortOrder) : Win32cr::Foundation::HRESULT
  ...
  record ViewsVtbl,
    ...
    add : Proc(Views*, Void*, Win32cr::System::Mmc::ViewOptions, Win32cr::Foundation::HRESULT),
    get__NewEnum : Proc(Views*, Void**, Win32cr::Foundation::HRESULT)


  @[Extern]
  #@[Com("d6b8c29d-a1ff-4d72-aab0-e381e9b9338d")]
  record Views, lpVtbl : ViewsVtbl* do
    ...
    def add(this : Views*, node : Void*, viewOptions : Win32cr::System::Mmc::ViewOptions) : Win32cr::Foundation::HRESULT
  ...
  record ViewVtbl,
    ...
    export_list : Proc(View*, Win32cr::Foundation::BSTR, Win32cr::System::Mmc::ExportListOptions, Win32cr::Foundation::HRESULT),
    get_ListViewMode : Proc(View*, Win32cr::System::Mmc::ListViewMode*, Win32cr::Foundation::HRESULT),
    put_ListViewMode : Proc(View*, Win32cr::System::Mmc::ListViewMode, Win32cr::Foundation::HRESULT),
    get_ControlObject : Proc(View*, Void**, Win32cr::Foundation::HRESULT)


  @[Extern]
  #@[Com("6efc2da2-b38c-457e-9abb-ed2d189b8c38")]
  record View, lpVtbl : ViewVtbl* do
    ...
    def export_list(this : View*, file : Win32cr::Foundation::BSTR, exportoptions : Win32cr::System::Mmc::ExportListOptions) : Win32cr::Foundation::HRESULT
      @lpVtbl.try &.value.export_list.call(this, file, exportoptions)
    end
    def get_ListViewMode(this : View*, mode : Win32cr::System::Mmc::ListViewMode*) : Win32cr::Foundation::HRESULT
      @lpVtbl.try &.value.get_ListViewMode.call(this, mode)
    end
    def put_ListViewMode(this : View*, mode : Win32cr::System::Mmc::ListViewMode) : Win32cr::Foundation::HRESULT
  ...
  @[Extern]
  #@[Com("313b01df-b22f-4d42-b1b8-483cdcf51d35")]
  ...
  @[Extern]
  #@[Com("dab39ce0-25e6-4e07-8362-ba9c95706545")]
  ...
  @[Extern]
  #@[Com("0178fad1-b361-4b27-96ad-67c57ebf2e1d")]
  ...
  @[Extern]
  #@[Com("2886abc2-a425-42b2-91c6-e25c0e04581c")]
  ...
  @[Extern]
  #@[Com("4600c3a5-e301-41d8-b6d0-ef2e4212e0ca")]
  ...
  @[Extern]
  #@[Com("955ab28a-5218-11d0-a985-00c04fd8d565")]
  ...
  @[Extern]
  #@[Com("43136eb2-d36c-11cf-adbc-00aa00a80033")]
  ...
  @[Extern]
  #@[Com("e8315a52-7a1a-11d0-a2d2-00c04fd909dd")]
  ...
  @[Extern]
  #@[Com("9cb396d8-ea83-11d0-aef1-00c04fb6dd2c")]
  ...
  @[Extern]
  #@[Com("43136eb1-d36c-11cf-adbc-00aa00a80033")]
  ...
  @[Extern]
  #@[Com("43136eb3-d36c-11cf-adbc-00aa00a80033")]
  ...
  @[Extern]
  #@[Com("43136eb7-d36c-11cf-adbc-00aa00a80033")]
  ...
  @[Extern]
  #@[Com("43136eb6-d36c-11cf-adbc-00aa00a80033")]
  ...
  @[Extern]
  #@[Com("4f3b7a4f-cfac-11cf-b8e3-00c04fd8d5b0")]
  ...
  @[Extern]
  #@[Com("43136eb8-d36c-11cf-adbc-00aa00a80033")]
  ...
  @[Extern]
  #@[Com("31da5fa0-e0eb-11cf-9f21-00aa003ca9f6")]
  ...
  @[Extern]
  #@[Com("bedeb620-f24d-11cf-8afc-00aa003ca9f6")]
  ...
  @[Extern]
  #@[Com("255f18cc-65db-11d1-a7dc-00c04fd8d565")]
  ...
  @[Extern]
  #@[Com("85de64dd-ef21-11cf-a285-00c04fd8dbe6")]
  ...
  @[Extern]
  #@[Com("85de64de-ef21-11cf-a285-00c04fd8dbe6")]
  ...
  @[Extern]
  #@[Com("85de64dc-ef21-11cf-a285-00c04fd8dbe6")]
  ...
  @[Extern]
  #@[Com("69fb811e-6c1c-11d0-a2cb-00c04fd909dd")]
  ...
  @[Extern]
  #@[Com("49506520-6f40-11d0-a98b-00c04fd8d565")]
  ...
  @[Extern]
  #@[Com("43136eb9-d36c-11cf-adbc-00aa00a80033")]
  ...
  @[Extern]
  #@[Com("e49f7a60-74af-11d0-a286-00c04fd8fe93")]
  ...
  @[Extern]
  #@[Com("1245208c-a151-11d0-a7d7-00c04fd909dd")]
  ...
  @[Extern]
  #@[Com("951ed750-d080-11d0-b197-000000000000")]
  ...
  @[Extern]
  #@[Com("a6b15ace-df59-11d0-a7dd-00c04fd909dd")]
  ...
  @[Extern]
  #@[Com("b7a87232-4a51-11d1-a7ea-00c04fd909dd")]
  ...
  @[Extern]
  #@[Com("9757abb8-1b32-11d1-a7ce-00c04fd8d565")]
  ...
  @[Extern]
  #@[Com("4861a010-20f9-11d2-a510-00c04fb6dd2c")]
  ...
  @[Extern]
  #@[Com("338698b1-5a02-11d1-9fec-00600832db4a")]
  ...
  @[Extern]
  #@[Com("8dee6511-554d-11d1-9fea-00600832db4a")]
  ...
  @[Extern]
  #@[Com("103d842a-aa63-11d1-a7e1-00c04fd8d565")]
  ...
  @[Extern]
  #@[Com("cc593830-b926-11d1-8063-0000f875a9ce")]
  ...
  @[Extern]
  #@[Com("72782d7a-a4a0-11d1-af0f-00c04fb6dd2c")]
  ...
  @[Extern]
  #@[Com("de40b7a4-0f65-11d2-8e25-00c04f8ecd78")]
  ...
  @[Extern]
  #@[Com("547c1354-024d-11d3-a707-00c04f8ef4cb")]
  ...
  @[Extern]
  #@[Com("80f94174-fccc-11d2-b991-00c04f8ecd78")]
  ...
  @[Extern]
  #@[Com("96933476-0251-11d3-aeb0-00c04f8ecd78")]
  ...
  @[Extern]
  #@[Com("cca0f2d2-82de-41b5-bf47-3b2076273d5c")]
  ...
  @[Extern]
  #@[Com("79a2d615-4a10-4ed4-8c65-8633f9335095")]
  ...
  @[Extern]
  #@[Com("e178bc0e-2ed0-4b5e-8097-42c9087e8b33")]
  ...
  @[Extern]
  #@[Com("a8d2c5fe-cdcb-4b9d-bde5-a27343ff54bc")]
  ...
  @[Extern]
  #@[Com("89995cee-d2ed-4c0e-ae5e-df7e76f3fa53")]
  ...
  @[Extern]
  #@[Com("34dd928a-7599-41e5-9f5e-d6bc3062c2da")]
  ...
  @[Extern]
  #@[Com("1cfbdd0e-62ca-49ce-a3af-dbb2de61b068")]
  ...
  @[Extern]
  #@[Com("3333759f-fe4f-4975-b143-fec0a5dd6d65")]
  ...
  @[Extern]
  #@[Com("15bc4d24-a522-4406-aa55-0749537a6865")]
  ...
  @[Extern]
  #@[Com("4f85efdb-d0e1-498c-8d4a-d010dfdd404f")]
  ...
  @[Extern]
  #@[Com("0f36e0eb-a7f1-4a81-be5a-9247f7de4b1b")]
