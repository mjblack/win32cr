...
module Win32cr::System::Ole
  ...
  @[Extern]
  record Wiresafearr_bstr,
    size : UInt32,
    aBstr : Win32cr::System::Com::FLAGGED_WORD_BLOB**

  @[Extern]
  record Wiresafearr_unknown,
    size : UInt32,
    apUnknown : Void**

  @[Extern]
  record Wiresafearr_dispatch,
    size : UInt32,
    apDispatch : Void**

  @[Extern]
  record Wiresafearr_variant,
    size : UInt32,
    aVariant : Win32cr::System::Ole::Wirevariant**

  @[Extern]
  record Wiresafearr_brecord,
    size : UInt32,
    aRecord : Win32cr::System::Ole::Wirebrecord**

  @[Extern]
  record Wiresafearr_haveiid,
    size : UInt32,
    apUnknown : Void**,
    iid : LibC::GUID

  @[Extern]
  record Wiresafearray_union,
    sfType : UInt32,
    u : U_e__struct do
    ...
    @[Extern(union: true)]
    record U_e__struct,
      bstr_str : Win32cr::System::Ole::Wiresafearr_bstr,
      unknown_str : Win32cr::System::Ole::Wiresafearr_unknown,
      dispatch_str : Win32cr::System::Ole::Wiresafearr_dispatch,
      variant_str : Win32cr::System::Ole::Wiresafearr_variant,
      record_str : Win32cr::System::Ole::Wiresafearr_brecord,
      have_iid_str : Win32cr::System::Ole::Wiresafearr_haveiid,
  ...
  @[Extern]
  record Wiresafearray,
    cDims : UInt16,
    fFeatures : UInt16,
    cbElements : UInt32,
    cLocks : UInt32,
    uArrayStructs : Win32cr::System::Ole::Wiresafearray_union,
  ...
  record Wirevariant,
    ...
    record Anonymous_e__Union,
      ...
      punkVal : Void*,
      pdispVal : Void*,
      parray : Win32cr::System::Ole::Wiresafearray**,
      brecVal : Win32cr::System::Ole::Wirebrecord*,
      pbVal : UInt8*,
      piVal : Int16*,
      plVal : Int32*,
      pllVal : Int64*,
      ...
      ppunkVal : Void**,
      ppdispVal : Void**,
      pparray : Win32cr::System::Ole::Wiresafearray***,
      pvarVal : Win32cr::System::Ole::Wirevariant**,
  ...
  record PICTDESC,
    ...
    record Anonymous_e__Union,
      ...
      wmf : Wmf_e__struct,
      icon : Icon_e__struct,
      emf : Emf_e__struct do

      # Nested Type Icon_e__struct
      @[Extern]
      record Icon_e__struct,
        hicon : Win32cr::UI::WindowsAndMessaging::HICON


      # Nested Type Bmp_e__struct
      @[Extern]
      record Bmp_e__struct,
        hbitmap : Win32cr::Graphics::Gdi::HBITMAP,
        hpal : Win32cr::Graphics::Gdi::HPALETTE


      # Nested Type Wmf_e__struct
      @[Extern]
      record Wmf_e__struct,
        hmeta : Win32cr::Graphics::Gdi::HMETAFILE,
        xExt : Int32,
        yExt : Int32


      # Nested Type Emf_e__struct
      @[Extern]
      record Emf_e__struct,
  ...
  lib C
    ...
    fun DoDragDrop(pDataObj : Void*, pDropSource : Void*, dwOKEffects : UInt32, pdwEffect : UInt32*) : Win32cr::Foundation::HRESULT
