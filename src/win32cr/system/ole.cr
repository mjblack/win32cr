...
module Win32cr::System::Ole
  ...
  struct PARAMDATA
    ...
    def initialize(@szName : Win32cr::Foundation::PWSTR, @vt : Win32cr::System::Com::VARENUM)
    end
  end
  ...
  struct METHODDATA
    ...
    property vtReturn : Win32cr::System::Com::VARENUM
    def initialize(@szName : Win32cr::Foundation::PWSTR, @ppdata : Win32cr::System::Ole::PARAMDATA*, @dispid : Int32, @iMeth : UInt32, @cc : Win32cr::System::Com::CALLCONV, @cArgs : UInt32, @wFlags : UInt16, @vtReturn : Win32cr::System::Com::VARENUM)
    end
  end
  ...
  record IDropTargetVtable,
    ...
    drag_enter : Proc(IDropTarget*, Void*, Win32cr::System::SystemServices::MODIFIERKEYS_FLAGS, Win32cr::Foundation::POINTL, UInt32*, Win32cr::Foundation::HRESULT),
    drag_over : Proc(IDropTarget*, Win32cr::System::SystemServices::MODIFIERKEYS_FLAGS, Win32cr::Foundation::POINTL, UInt32*, Win32cr::Foundation::HRESULT),
    drag_leave : Proc(IDropTarget*, Win32cr::Foundation::HRESULT),
    drop : Proc(IDropTarget*, Void*, Win32cr::System::SystemServices::MODIFIERKEYS_FLAGS, Win32cr::Foundation::POINTL, UInt32*, Win32cr::Foundation::HRESULT)
  ...
  record IDropTarget, lpVtbl : IDropTargetVtable* do
    ...
    def drag_enter(this : IDropTarget*, pDataObj : Void*, grfKeyState : Win32cr::System::SystemServices::MODIFIERKEYS_FLAGS, pt : Win32cr::Foundation::POINTL, pdwEffect : UInt32*) : Win32cr::Foundation::HRESULT
      @lpVtbl.try &.value.drag_enter.call(this, pDataObj, grfKeyState, pt, pdwEffect)
    end
    def drag_over(this : IDropTarget*, grfKeyState : Win32cr::System::SystemServices::MODIFIERKEYS_FLAGS, pt : Win32cr::Foundation::POINTL, pdwEffect : UInt32*) : Win32cr::Foundation::HRESULT
    ...
    def drop(this : IDropTarget*, pDataObj : Void*, grfKeyState : Win32cr::System::SystemServices::MODIFIERKEYS_FLAGS, pt : Win32cr::Foundation::POINTL, pdwEffect : UInt32*) : Win32cr::Foundation::HRESULT
  ...
  record IVariantChangeTypeVtable,
    ...
    change_type : Proc(IVariantChangeType*, Win32cr::System::Com::VARIANT*, Win32cr::System::Com::VARIANT*, UInt32, Win32cr::System::Com::VARENUM, Win32cr::Foundation::HRESULT)
  ...
  record IVariantChangeType, lpVtbl : IVariantChangeTypeVtable* do
    ...
    def change_type(this : IVariantChangeType*, pvarDst : Win32cr::System::Com::VARIANT*, pvarSrc : Win32cr::System::Com::VARIANT*, lcid : UInt32, vtNew : Win32cr::System::Com::VARENUM) : Win32cr::Foundation::HRESULT
  ...
  def safeArrayAllocDescriptorEx(vt : Win32cr::System::Com::VARENUM, cDims : UInt32, ppsaOut : Win32cr::System::Com::SAFEARRAY**) : Win32cr::Foundation::HRESULT
    {% if !flag?(:docs) %}
  ...
  def safeArrayCreate(vt : Win32cr::System::Com::VARENUM, cDims : UInt32, rgsabound : Win32cr::System::Com::SAFEARRAYBOUND*) : Win32cr::System::Com::SAFEARRAY*
    {% if !flag?(:docs) %}
    C.SafeArrayCreate(vt, cDims, rgsabound)
    {% end %}
  end

  def safeArrayCreateEx(vt : Win32cr::System::Com::VARENUM, cDims : UInt32, rgsabound : Win32cr::System::Com::SAFEARRAYBOUND*, pvExtra : Void*) : Win32cr::System::Com::SAFEARRAY*
    {% if !flag?(:docs) %}
  ...
  def safeArrayCreateVector(vt : Win32cr::System::Com::VARENUM, lLbound : Int32, cElements : UInt32) : Win32cr::System::Com::SAFEARRAY*
    {% if !flag?(:docs) %}
    C.SafeArrayCreateVector(vt, lLbound, cElements)
    {% end %}
  end

  def safeArrayCreateVectorEx(vt : Win32cr::System::Com::VARENUM, lLbound : Int32, cElements : UInt32, pvExtra : Void*) : Win32cr::System::Com::SAFEARRAY*
    {% if !flag?(:docs) %}
  ...
  def variantChangeType(pvargDest : Win32cr::System::Com::VARIANT*, pvarSrc : Win32cr::System::Com::VARIANT*, wFlags : UInt16, vt : Win32cr::System::Com::VARENUM) : Win32cr::Foundation::HRESULT
    {% if !flag?(:docs) %}
    C.VariantChangeType(pvargDest, pvarSrc, wFlags, vt)
    {% end %}
  end

  def variantChangeTypeEx(pvargDest : Win32cr::System::Com::VARIANT*, pvarSrc : Win32cr::System::Com::VARIANT*, lcid : UInt32, wFlags : UInt16, vt : Win32cr::System::Com::VARENUM) : Win32cr::Foundation::HRESULT
    {% if !flag?(:docs) %}
  ...
  def dispGetParam(pdispparams : Win32cr::System::Com::DISPPARAMS*, position : UInt32, vtTarg : Win32cr::System::Com::VARENUM, pvarResult : Win32cr::System::Com::VARIANT*, puArgErr : UInt32*) : Win32cr::Foundation::HRESULT
    {% if !flag?(:docs) %}
  ...
  def dispCallFunc(pvInstance : Void*, oVft : LibC::UIntPtrT, cc : Win32cr::System::Com::CALLCONV, vtReturn : Win32cr::System::Com::VARENUM, cActuals : UInt32, prgvt : UInt16*, prgpvarg : Win32cr::System::Com::VARIANT**, pvargResult : Win32cr::System::Com::VARIANT*) : Win32cr::Foundation::HRESULT
    {% if !flag?(:docs) %}
  ...
  @[Link("oleaut32.dll")]
  @[Link("ole32.dll")]
  @[Link("api-ms-win-core-marshal-l1-1-0.dll")]
  @[Link("oledlg.dll")]
  {% if !flag?(:docs) %}
  lib C
    # :nodoc:
    ...
    # :nodoc:
    fun SafeArrayAllocDescriptorEx(vt : Win32cr::System::Com::VARENUM, cDims : UInt32, ppsaOut : Win32cr::System::Com::SAFEARRAY**) : Win32cr::Foundation::HRESULT

    # :nodoc:
    fun SafeArrayAllocData(psa : Win32cr::System::Com::SAFEARRAY*) : Win32cr::Foundation::HRESULT

    # :nodoc:
    fun SafeArrayCreate(vt : Win32cr::System::Com::VARENUM, cDims : UInt32, rgsabound : Win32cr::System::Com::SAFEARRAYBOUND*) : Win32cr::System::Com::SAFEARRAY*

    # :nodoc:
    fun SafeArrayCreateEx(vt : Win32cr::System::Com::VARENUM, cDims : UInt32, rgsabound : Win32cr::System::Com::SAFEARRAYBOUND*, pvExtra : Void*) : Win32cr::System::Com::SAFEARRAY*
    ...
    # :nodoc:
    fun SafeArrayCreateVector(vt : Win32cr::System::Com::VARENUM, lLbound : Int32, cElements : UInt32) : Win32cr::System::Com::SAFEARRAY*

    # :nodoc:
    fun SafeArrayCreateVectorEx(vt : Win32cr::System::Com::VARENUM, lLbound : Int32, cElements : UInt32, pvExtra : Void*) : Win32cr::System::Com::SAFEARRAY*
    ...
    # :nodoc:
    fun VariantChangeType(pvargDest : Win32cr::System::Com::VARIANT*, pvarSrc : Win32cr::System::Com::VARIANT*, wFlags : UInt16, vt : Win32cr::System::Com::VARENUM) : Win32cr::Foundation::HRESULT

    # :nodoc:
    fun VariantChangeTypeEx(pvargDest : Win32cr::System::Com::VARIANT*, pvarSrc : Win32cr::System::Com::VARIANT*, lcid : UInt32, wFlags : UInt16, vt : Win32cr::System::Com::VARENUM) : Win32cr::Foundation::HRESULT
    ...
    # :nodoc:
    fun DispGetParam(pdispparams : Win32cr::System::Com::DISPPARAMS*, position : UInt32, vtTarg : Win32cr::System::Com::VARENUM, pvarResult : Win32cr::System::Com::VARIANT*, puArgErr : UInt32*) : Win32cr::Foundation::HRESULT
    ...
    # :nodoc:
    fun DispCallFunc(pvInstance : Void*, oVft : LibC::UIntPtrT, cc : Win32cr::System::Com::CALLCONV, vtReturn : Win32cr::System::Com::VARENUM, cActuals : UInt32, prgvt : UInt16*, prgpvarg : Win32cr::System::Com::VARIANT**, pvargResult : Win32cr::System::Com::VARIANT*) : Win32cr::Foundation::HRESULT
