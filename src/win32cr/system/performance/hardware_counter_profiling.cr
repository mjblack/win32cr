...
module Win32cr::System::Performance::HardwareCounterProfiling
  ...
  @[Extern]
  record HARDWARE_COUNTER_DATA,
    type__ : Win32cr::System::Performance::HardwareCounterProfiling::HARDWARE_COUNTER_TYPE,
    reserved : UInt32,
    value : UInt64
  ...
  record PERFORMANCE_DATA,
    ...
    retry_count : UInt32,
    reserved : UInt32,
    hw_counters : Win32cr::System::Performance::HardwareCounterProfiling::HARDWARE_COUNTER_DATA[16]
