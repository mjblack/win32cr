...
module Win32cr::System::Diagnostics::ProcessSnapshotting
  ...
  record PSS_HANDLE_ENTRY,
    ...
    type_specific_information : TypeSpecificInformation_e__Union do

    # Nested Type TypeSpecificInformation_e__Union
    @[Extern(union: true)]
    record TypeSpecificInformation_e__Union,
      process : Process_e__Struct,
      thread : Thread_e__Struct,
      mutant : Mutant_e__Struct,
      event : Event_e__Struct,
      section : Section_e__Struct,
      semaphore : Semaphore_e__Struct do

      # Nested Type Semaphore_e__Struct
      @[Extern]
      record Semaphore_e__Struct,
        current_count : Int32,
        maximum_count : Int32
      ...
      # Nested Type Thread_e__Struct
      @[Extern]
      record Thread_e__Struct,
        exit_status : UInt32,
      ...
      # Nested Type Process_e__Struct
      @[Extern]
      record Process_e__Struct,
        exit_status : UInt32,
        peb_base_address : Void*,
        affinity_mask : LibC::UIntPtrT,
        base_priority : Int32,
      ...
      # Nested Type Mutant_e__Struct
      @[Extern]
      record Mutant_e__Struct,
        current_count : Int32,
