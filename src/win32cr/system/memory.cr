...
module Win32cr::System::Memory
  ...
  @[Link("kernel32.dll")]
  @[Link("api-ms-win-core-memory-l1-1-3.dll")]
  @[Link("api-ms-win-core-memory-l1-1-7.dll")]
  @[Link("api-ms-win-core-memory-l1-1-4.dll")]
  @[Link("api-ms-win-core-memory-l1-1-5.dll")]
  @[Link("api-ms-win-core-memory-l1-1-6.dll")]
  @[Link("api-ms-win-core-memory-l1-1-8.dll")]
  @[Link("ntdll.dll")]
  {% if !flag?(:docs) %}
  lib C
    # :nodoc:
