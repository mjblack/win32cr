...
module Win32cr::System::Search
  ...
  record SQL_INTERVAL_STRUCT,
    ...
    interval_sign : Int16,
    intval : Intval_e__union do

    # Nested Type Intval_e__union
    @[Extern(union: true)]
    record Intval_e__union,
  ...
  record SSVARIANT,
    ...
    record Anonymous_e__Union,
      ...
      blob_type : BLOBType do

      # Nested Type UnknownType
      @[Extern]
      record UnknownType,
