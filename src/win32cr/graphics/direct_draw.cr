...
module Win32cr::Graphics::DirectDraw
  ...
  alias PDD_DESTROYDRIVER = Proc(Win32cr::Graphics::DirectDraw::DD_DESTROYDRIVERDATA*, UInt32)*

  alias PDD_SETMODE = Proc(Win32cr::Graphics::DirectDraw::DD_SETMODEDATA*, UInt32)*
  ...
  alias PDD_VPORTCB_GETAUTOFLIPSURF = Proc(Win32cr::Graphics::DirectDraw::DD_GETVPORTAUTOFLIPSURFACEDATA*, UInt32)*
  ...
  record DDPIXELFORMAT,
    ...
    record Anonymous3_e__Union,
      ...
      multi_sample_caps : MultiSampleCaps_e__Struct do

      # Nested Type MultiSampleCaps_e__Struct
      @[Extern]
      record MultiSampleCaps_e__Struct,
        wFlipMSTypes : UInt16,
        wBltMSTypes : UInt16
  ...
  record SURFACEALIGNMENT,
    ...
    @[Extern(union: true)]
    record Anonymous_e__Union,
      linear : Linear_e__Struct,
      rectangular : Rectangular_e__Struct do

      # Nested Type Linear_e__Struct
      @[Extern]
      record Linear_e__Struct,
      ...
      # Nested Type Rectangular_e__Struct
      @[Extern]
      record Rectangular_e__Struct,
        dwXAlignment : UInt32,
        dwYAlignment : UInt32,
        dwFlags : UInt32,
        dwReserved2 : UInt32
  ...
  @[Extern]
  record DD_DESTROYDRIVERDATA
  @[Extern]
  record DD_SETMODEDATA
  @[Extern]
  record DD_GETVPORTAUTOFLIPSURFACEDATA
  @[Extern]
  record VIDEOMEMORY,
    dwFlags : UInt32,
    fpStart : LibC::UIntPtrT,
