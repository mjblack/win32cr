...
module Win32cr::Graphics::DirectWrite
  ...
  record DWRITE_PANOSE,
    ...
    familyKind : UInt8,
    text : Text_e__struct,
    script : Script_e__struct,
    decorative : Decorative_e__struct,
    symbol : Symbol_e__struct do

    # Nested Type Decorative_e__struct
    @[Extern]
    record Decorative_e__struct,
      familyKind : UInt8,
    ...
    # Nested Type Text_e__struct
    @[Extern]
    record Text_e__struct,
      familyKind : UInt8,
      serifStyle : UInt8,
      weight : UInt8,
      proportion : UInt8,
    ...
    # Nested Type Symbol_e__struct
    @[Extern]
    record Symbol_e__struct,
      familyKind : UInt8,
      symbolKind : UInt8,
      weight : UInt8,
      spacing : UInt8,
    ...
    # Nested Type Script_e__struct
    @[Extern]
    record Script_e__struct,
      familyKind : UInt8,
      toolKind : UInt8,
      weight : UInt8,
      spacing : UInt8,
