...
module Win32cr::Graphics::Direct2D
  ...
  @[Extern]
  struct Matrix4x3F
    property base : Win32cr::Graphics::Direct2D::Common::D2D_MATRIX_4X3_F
    def initialize(@base : Win32cr::Graphics::Direct2D::Common::D2D_MATRIX_4X3_F)
    end
  end

  @[Extern]
  struct Matrix4x4F
    property base : Win32cr::Graphics::Direct2D::Common::D2D_MATRIX_4X4_F
    def initialize(@base : Win32cr::Graphics::Direct2D::Common::D2D_MATRIX_4X4_F)
    end
  end

  @[Extern]
  struct Matrix5x4F
    property base : Win32cr::Graphics::Direct2D::Common::D2D_MATRIX_5X4_F
    def initialize(@base : Win32cr::Graphics::Direct2D::Common::D2D_MATRIX_5X4_F)
    end
  end
