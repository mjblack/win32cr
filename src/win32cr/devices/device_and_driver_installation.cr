...
module Win32cr::Devices::DeviceAndDriverInstallation
  ...
  record CM_NOTIFY_FILTER,
    ...
    @[Extern(union: true)]
    record U_e__union,
      device_interface : DeviceInterface_e__Struct,
      device_handle : DeviceHandle_e__Struct,
      device_instance : DeviceInstance_e__Struct do

      # Nested Type DeviceHandle_e__Struct
      @[Extern]
      record DeviceHandle_e__Struct,
        hTarget : Win32cr::Foundation::HANDLE


      # Nested Type DeviceInstance_e__Struct
      @[Extern]
      record DeviceInstance_e__Struct,
        instance_id : UInt16[200]


      # Nested Type DeviceInterface_e__Struct
      @[Extern]
      record DeviceInterface_e__Struct,
        class_guid : LibC::GUID
