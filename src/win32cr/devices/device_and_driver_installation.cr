...
module Win32cr::Devices::DeviceAndDriverInstallation
  ...
  def cMCreateDevNodeA(pdnDevInst : UInt32*, pDeviceID : Win32cr::Foundation::PSTR, dnParent : UInt32, ulFlags : UInt32) : Win32cr::Devices::DeviceAndDriverInstallation::CONFIGRET
    {% if !flag?(:docs) %}
    C.CM_Create_DevNodeA(pdnDevInst, pDeviceID, dnParent, ulFlags)
    {% end %}
  end

  def cMCreateDevNodeW(pdnDevInst : UInt32*, pDeviceID : Win32cr::Foundation::PWSTR, dnParent : UInt32, ulFlags : UInt32) : Win32cr::Devices::DeviceAndDriverInstallation::CONFIGRET
    {% if !flag?(:docs) %}
    C.CM_Create_DevNodeW(pdnDevInst, pDeviceID, dnParent, ulFlags)
    {% end %}
  end

  def cMCreateDevNodeExA(pdnDevInst : UInt32*, pDeviceID : Win32cr::Foundation::PSTR, dnParent : UInt32, ulFlags : UInt32, hMachine : LibC::IntPtrT) : Win32cr::Devices::DeviceAndDriverInstallation::CONFIGRET
    {% if !flag?(:docs) %}
    C.CM_Create_DevNode_ExA(pdnDevInst, pDeviceID, dnParent, ulFlags, hMachine)
    {% end %}
  end

  def cMCreateDevNodeExW(pdnDevInst : UInt32*, pDeviceID : Win32cr::Foundation::PWSTR, dnParent : UInt32, ulFlags : UInt32, hMachine : LibC::IntPtrT) : Win32cr::Devices::DeviceAndDriverInstallation::CONFIGRET
    {% if !flag?(:docs) %}
  ...
  def cMGetHWProfFlagsA(pDeviceID : Win32cr::Foundation::PSTR, ulHardwareProfile : UInt32, pulValue : UInt32*, ulFlags : UInt32) : Win32cr::Devices::DeviceAndDriverInstallation::CONFIGRET
    {% if !flag?(:docs) %}
    C.CM_Get_HW_Prof_FlagsA(pDeviceID, ulHardwareProfile, pulValue, ulFlags)
    {% end %}
  end

  def cMGetHWProfFlagsW(pDeviceID : Win32cr::Foundation::PWSTR, ulHardwareProfile : UInt32, pulValue : UInt32*, ulFlags : UInt32) : Win32cr::Devices::DeviceAndDriverInstallation::CONFIGRET
    {% if !flag?(:docs) %}
    C.CM_Get_HW_Prof_FlagsW(pDeviceID, ulHardwareProfile, pulValue, ulFlags)
    {% end %}
  end

  def cMGetHWProfFlagsExA(pDeviceID : Win32cr::Foundation::PSTR, ulHardwareProfile : UInt32, pulValue : UInt32*, ulFlags : UInt32, hMachine : LibC::IntPtrT) : Win32cr::Devices::DeviceAndDriverInstallation::CONFIGRET
    {% if !flag?(:docs) %}
    C.CM_Get_HW_Prof_Flags_ExA(pDeviceID, ulHardwareProfile, pulValue, ulFlags, hMachine)
    {% end %}
  end

  def cMGetHWProfFlagsExW(pDeviceID : Win32cr::Foundation::PWSTR, ulHardwareProfile : UInt32, pulValue : UInt32*, ulFlags : UInt32, hMachine : LibC::IntPtrT) : Win32cr::Devices::DeviceAndDriverInstallation::CONFIGRET
    {% if !flag?(:docs) %}
  ...
  def cMGetDeviceInterfaceListA(interface_class_guid : LibC::GUID*, pDeviceID : Win32cr::Foundation::PSTR, buffer : UInt8*, buffer_len : UInt32, ulFlags : UInt32) : Win32cr::Devices::DeviceAndDriverInstallation::CONFIGRET
    {% if !flag?(:docs) %}
    C.CM_Get_Device_Interface_ListA(interface_class_guid, pDeviceID, buffer, buffer_len, ulFlags)
    {% end %}
  end

  def cMGetDeviceInterfaceListW(interface_class_guid : LibC::GUID*, pDeviceID : Win32cr::Foundation::PWSTR, buffer : UInt16*, buffer_len : UInt32, ulFlags : UInt32) : Win32cr::Devices::DeviceAndDriverInstallation::CONFIGRET
    {% if !flag?(:docs) %}
    C.CM_Get_Device_Interface_ListW(interface_class_guid, pDeviceID, buffer, buffer_len, ulFlags)
    {% end %}
  end

  def cMGetDeviceInterfaceListExA(interface_class_guid : LibC::GUID*, pDeviceID : Win32cr::Foundation::PSTR, buffer : UInt8*, buffer_len : UInt32, ulFlags : UInt32, hMachine : LibC::IntPtrT) : Win32cr::Devices::DeviceAndDriverInstallation::CONFIGRET
    {% if !flag?(:docs) %}
    C.CM_Get_Device_Interface_List_ExA(interface_class_guid, pDeviceID, buffer, buffer_len, ulFlags, hMachine)
    {% end %}
  end

  def cMGetDeviceInterfaceListExW(interface_class_guid : LibC::GUID*, pDeviceID : Win32cr::Foundation::PWSTR, buffer : UInt16*, buffer_len : UInt32, ulFlags : UInt32, hMachine : LibC::IntPtrT) : Win32cr::Devices::DeviceAndDriverInstallation::CONFIGRET
    {% if !flag?(:docs) %}
    C.CM_Get_Device_Interface_List_ExW(interface_class_guid, pDeviceID, buffer, buffer_len, ulFlags, hMachine)
    {% end %}
  end

  def cMGetDeviceInterfaceListSizeA(pulLen : UInt32*, interface_class_guid : LibC::GUID*, pDeviceID : Win32cr::Foundation::PSTR, ulFlags : UInt32) : Win32cr::Devices::DeviceAndDriverInstallation::CONFIGRET
    {% if !flag?(:docs) %}
    C.CM_Get_Device_Interface_List_SizeA(pulLen, interface_class_guid, pDeviceID, ulFlags)
    {% end %}
  end

  def cMGetDeviceInterfaceListSizeW(pulLen : UInt32*, interface_class_guid : LibC::GUID*, pDeviceID : Win32cr::Foundation::PWSTR, ulFlags : UInt32) : Win32cr::Devices::DeviceAndDriverInstallation::CONFIGRET
    {% if !flag?(:docs) %}
    C.CM_Get_Device_Interface_List_SizeW(pulLen, interface_class_guid, pDeviceID, ulFlags)
    {% end %}
  end

  def cMGetDeviceInterfaceListSizeExA(pulLen : UInt32*, interface_class_guid : LibC::GUID*, pDeviceID : Win32cr::Foundation::PSTR, ulFlags : UInt32, hMachine : LibC::IntPtrT) : Win32cr::Devices::DeviceAndDriverInstallation::CONFIGRET
    {% if !flag?(:docs) %}
    C.CM_Get_Device_Interface_List_Size_ExA(pulLen, interface_class_guid, pDeviceID, ulFlags, hMachine)
    {% end %}
  end

  def cMGetDeviceInterfaceListSizeExW(pulLen : UInt32*, interface_class_guid : LibC::GUID*, pDeviceID : Win32cr::Foundation::PWSTR, ulFlags : UInt32, hMachine : LibC::IntPtrT) : Win32cr::Devices::DeviceAndDriverInstallation::CONFIGRET
    {% if !flag?(:docs) %}
  ...
  def cMLocateDevNodeA(pdnDevInst : UInt32*, pDeviceID : Win32cr::Foundation::PSTR, ulFlags : UInt32) : Win32cr::Devices::DeviceAndDriverInstallation::CONFIGRET
    {% if !flag?(:docs) %}
    C.CM_Locate_DevNodeA(pdnDevInst, pDeviceID, ulFlags)
    {% end %}
  end

  def cMLocateDevNodeW(pdnDevInst : UInt32*, pDeviceID : Win32cr::Foundation::PWSTR, ulFlags : UInt32) : Win32cr::Devices::DeviceAndDriverInstallation::CONFIGRET
    {% if !flag?(:docs) %}
    C.CM_Locate_DevNodeW(pdnDevInst, pDeviceID, ulFlags)
    {% end %}
  end

  def cMLocateDevNodeExA(pdnDevInst : UInt32*, pDeviceID : Win32cr::Foundation::PSTR, ulFlags : UInt32, hMachine : LibC::IntPtrT) : Win32cr::Devices::DeviceAndDriverInstallation::CONFIGRET
    {% if !flag?(:docs) %}
    C.CM_Locate_DevNode_ExA(pdnDevInst, pDeviceID, ulFlags, hMachine)
    {% end %}
  end

  def cMLocateDevNodeExW(pdnDevInst : UInt32*, pDeviceID : Win32cr::Foundation::PWSTR, ulFlags : UInt32, hMachine : LibC::IntPtrT) : Win32cr::Devices::DeviceAndDriverInstallation::CONFIGRET
    {% if !flag?(:docs) %}
  ...
  def cMSetHWProfFlagsA(pDeviceID : Win32cr::Foundation::PSTR, ulConfig : UInt32, ulValue : UInt32, ulFlags : UInt32) : Win32cr::Devices::DeviceAndDriverInstallation::CONFIGRET
    {% if !flag?(:docs) %}
    C.CM_Set_HW_Prof_FlagsA(pDeviceID, ulConfig, ulValue, ulFlags)
    {% end %}
  end

  def cMSetHWProfFlagsW(pDeviceID : Win32cr::Foundation::PWSTR, ulConfig : UInt32, ulValue : UInt32, ulFlags : UInt32) : Win32cr::Devices::DeviceAndDriverInstallation::CONFIGRET
    {% if !flag?(:docs) %}
    C.CM_Set_HW_Prof_FlagsW(pDeviceID, ulConfig, ulValue, ulFlags)
    {% end %}
  end

  def cMSetHWProfFlagsExA(pDeviceID : Win32cr::Foundation::PSTR, ulConfig : UInt32, ulValue : UInt32, ulFlags : UInt32, hMachine : LibC::IntPtrT) : Win32cr::Devices::DeviceAndDriverInstallation::CONFIGRET
    {% if !flag?(:docs) %}
    C.CM_Set_HW_Prof_Flags_ExA(pDeviceID, ulConfig, ulValue, ulFlags, hMachine)
    {% end %}
  end

  def cMSetHWProfFlagsExW(pDeviceID : Win32cr::Foundation::PWSTR, ulConfig : UInt32, ulValue : UInt32, ulFlags : UInt32, hMachine : LibC::IntPtrT) : Win32cr::Devices::DeviceAndDriverInstallation::CONFIGRET
    {% if !flag?(:docs) %}
  ...
  lib C
    ...
    # :nodoc:
    fun CM_Create_DevNodeA(pdnDevInst : UInt32*, pDeviceID : Win32cr::Foundation::PSTR, dnParent : UInt32, ulFlags : UInt32) : Win32cr::Devices::DeviceAndDriverInstallation::CONFIGRET

    # :nodoc:
    fun CM_Create_DevNodeW(pdnDevInst : UInt32*, pDeviceID : Win32cr::Foundation::PWSTR, dnParent : UInt32, ulFlags : UInt32) : Win32cr::Devices::DeviceAndDriverInstallation::CONFIGRET

    # :nodoc:
    fun CM_Create_DevNode_ExA(pdnDevInst : UInt32*, pDeviceID : Win32cr::Foundation::PSTR, dnParent : UInt32, ulFlags : UInt32, hMachine : LibC::IntPtrT) : Win32cr::Devices::DeviceAndDriverInstallation::CONFIGRET

    # :nodoc:
    fun CM_Create_DevNode_ExW(pdnDevInst : UInt32*, pDeviceID : Win32cr::Foundation::PWSTR, dnParent : UInt32, ulFlags : UInt32, hMachine : LibC::IntPtrT) : Win32cr::Devices::DeviceAndDriverInstallation::CONFIGRET
    ...
    # :nodoc:
    fun CM_Get_HW_Prof_FlagsA(pDeviceID : Win32cr::Foundation::PSTR, ulHardwareProfile : UInt32, pulValue : UInt32*, ulFlags : UInt32) : Win32cr::Devices::DeviceAndDriverInstallation::CONFIGRET

    # :nodoc:
    fun CM_Get_HW_Prof_FlagsW(pDeviceID : Win32cr::Foundation::PWSTR, ulHardwareProfile : UInt32, pulValue : UInt32*, ulFlags : UInt32) : Win32cr::Devices::DeviceAndDriverInstallation::CONFIGRET

    # :nodoc:
    fun CM_Get_HW_Prof_Flags_ExA(pDeviceID : Win32cr::Foundation::PSTR, ulHardwareProfile : UInt32, pulValue : UInt32*, ulFlags : UInt32, hMachine : LibC::IntPtrT) : Win32cr::Devices::DeviceAndDriverInstallation::CONFIGRET

    # :nodoc:
    fun CM_Get_HW_Prof_Flags_ExW(pDeviceID : Win32cr::Foundation::PWSTR, ulHardwareProfile : UInt32, pulValue : UInt32*, ulFlags : UInt32, hMachine : LibC::IntPtrT) : Win32cr::Devices::DeviceAndDriverInstallation::CONFIGRET
    ...
    # :nodoc:
    fun CM_Get_Device_Interface_ListA(interface_class_guid : LibC::GUID*, pDeviceID : Win32cr::Foundation::PSTR, buffer : UInt8*, buffer_len : UInt32, ulFlags : UInt32) : Win32cr::Devices::DeviceAndDriverInstallation::CONFIGRET

    # :nodoc:
    fun CM_Get_Device_Interface_ListW(interface_class_guid : LibC::GUID*, pDeviceID : Win32cr::Foundation::PWSTR, buffer : UInt16*, buffer_len : UInt32, ulFlags : UInt32) : Win32cr::Devices::DeviceAndDriverInstallation::CONFIGRET

    # :nodoc:
    fun CM_Get_Device_Interface_List_ExA(interface_class_guid : LibC::GUID*, pDeviceID : Win32cr::Foundation::PSTR, buffer : UInt8*, buffer_len : UInt32, ulFlags : UInt32, hMachine : LibC::IntPtrT) : Win32cr::Devices::DeviceAndDriverInstallation::CONFIGRET

    # :nodoc:
    fun CM_Get_Device_Interface_List_ExW(interface_class_guid : LibC::GUID*, pDeviceID : Win32cr::Foundation::PWSTR, buffer : UInt16*, buffer_len : UInt32, ulFlags : UInt32, hMachine : LibC::IntPtrT) : Win32cr::Devices::DeviceAndDriverInstallation::CONFIGRET

    # :nodoc:
    fun CM_Get_Device_Interface_List_SizeA(pulLen : UInt32*, interface_class_guid : LibC::GUID*, pDeviceID : Win32cr::Foundation::PSTR, ulFlags : UInt32) : Win32cr::Devices::DeviceAndDriverInstallation::CONFIGRET

    # :nodoc:
    fun CM_Get_Device_Interface_List_SizeW(pulLen : UInt32*, interface_class_guid : LibC::GUID*, pDeviceID : Win32cr::Foundation::PWSTR, ulFlags : UInt32) : Win32cr::Devices::DeviceAndDriverInstallation::CONFIGRET

    # :nodoc:
    fun CM_Get_Device_Interface_List_Size_ExA(pulLen : UInt32*, interface_class_guid : LibC::GUID*, pDeviceID : Win32cr::Foundation::PSTR, ulFlags : UInt32, hMachine : LibC::IntPtrT) : Win32cr::Devices::DeviceAndDriverInstallation::CONFIGRET

    # :nodoc:
    fun CM_Get_Device_Interface_List_Size_ExW(pulLen : UInt32*, interface_class_guid : LibC::GUID*, pDeviceID : Win32cr::Foundation::PWSTR, ulFlags : UInt32, hMachine : LibC::IntPtrT) : Win32cr::Devices::DeviceAndDriverInstallation::CONFIGRET
    ...
    # :nodoc:
    fun CM_Locate_DevNodeA(pdnDevInst : UInt32*, pDeviceID : Win32cr::Foundation::PSTR, ulFlags : UInt32) : Win32cr::Devices::DeviceAndDriverInstallation::CONFIGRET

    # :nodoc:
    fun CM_Locate_DevNodeW(pdnDevInst : UInt32*, pDeviceID : Win32cr::Foundation::PWSTR, ulFlags : UInt32) : Win32cr::Devices::DeviceAndDriverInstallation::CONFIGRET

    # :nodoc:
    fun CM_Locate_DevNode_ExA(pdnDevInst : UInt32*, pDeviceID : Win32cr::Foundation::PSTR, ulFlags : UInt32, hMachine : LibC::IntPtrT) : Win32cr::Devices::DeviceAndDriverInstallation::CONFIGRET

    # :nodoc:
    fun CM_Locate_DevNode_ExW(pdnDevInst : UInt32*, pDeviceID : Win32cr::Foundation::PWSTR, ulFlags : UInt32, hMachine : LibC::IntPtrT) : Win32cr::Devices::DeviceAndDriverInstallation::CONFIGRET
    ...
    # :nodoc:
    fun CM_Set_HW_Prof_FlagsA(pDeviceID : Win32cr::Foundation::PSTR, ulConfig : UInt32, ulValue : UInt32, ulFlags : UInt32) : Win32cr::Devices::DeviceAndDriverInstallation::CONFIGRET

    # :nodoc:
    fun CM_Set_HW_Prof_FlagsW(pDeviceID : Win32cr::Foundation::PWSTR, ulConfig : UInt32, ulValue : UInt32, ulFlags : UInt32) : Win32cr::Devices::DeviceAndDriverInstallation::CONFIGRET

    # :nodoc:
    fun CM_Set_HW_Prof_Flags_ExA(pDeviceID : Win32cr::Foundation::PSTR, ulConfig : UInt32, ulValue : UInt32, ulFlags : UInt32, hMachine : LibC::IntPtrT) : Win32cr::Devices::DeviceAndDriverInstallation::CONFIGRET

    # :nodoc:
    fun CM_Set_HW_Prof_Flags_ExW(pDeviceID : Win32cr::Foundation::PWSTR, ulConfig : UInt32, ulValue : UInt32, ulFlags : UInt32, hMachine : LibC::IntPtrT) : Win32cr::Devices::DeviceAndDriverInstallation::CONFIGRET
