...
module Win32cr::Devices::BiometricFramework
  ...
  record WINBIO_IDENTITY,
    ...
    record Value_e__Union,
      ...
      account_sid : AccountSid_e__Struct,
      secure_id : UInt8[32] do

      # Nested Type AccountSid_e__Struct
      @[Extern]
      record AccountSid_e__Struct,
        size : UInt32,
        data : UInt8[68]
  ...
  record WINBIO_BIR_HEADER,
    ...
    validity_period : ValidityPeriod_e__Struct,
    ...
    # Nested Type ValidityPeriod_e__Struct
    @[Extern]
    record ValidityPeriod_e__Struct,
  ...
  record WINBIO_EVENT,
    type__ : UInt32,
    parameters : Parameters_e__Union do

    # Nested Type Parameters_e__Union
    @[Extern(union: true)]
    record Parameters_e__Union,
      unclaimed : Unclaimed_e__Struct,
      unclaimed_identify : UnclaimedIdentify_e__Struct,
      error : Error_e__Struct do

      # Nested Type UnclaimedIdentify_e__Struct
      @[Extern]
      record UnclaimedIdentify_e__Struct,
        unit_id : UInt32,
      ...
      # Nested Type Unclaimed_e__Struct
      @[Extern]
      record Unclaimed_e__Struct,
        unit_id : UInt32,
        reject_detail : UInt32
  ...
  record WINBIO_PRESENCE_PROPERTIES,
    facial_features : FacialFeatures_e__Struct,
    iris : Iris_e__Struct do

    # Nested Type Iris_e__Struct
    @[Extern]
    record Iris_e__Struct,
    ...
    # Nested Type FacialFeatures_e__Struct
    @[Extern]
    record FacialFeatures_e__Struct,
      bounding_box : Win32cr::Foundation::RECT,
      distance : Int32,
      opaque_engine_data : OpaqueEngineData_e__Struct do

      # Nested Type OpaqueEngineData_e__Struct
      @[Extern]
      record OpaqueEngineData_e__Struct,
  ...
  record WINBIO_PRESENCE,
    ...
    authorization : Authorization_e__Struct do

    # Nested Type Authorization_e__Struct
    @[Extern]
    record Authorization_e__Struct,
      size : UInt32,
      data : UInt8[32]
  ...
  record WINBIO_EXTENDED_SENSOR_INFO,
    ...
    factor : UInt32,
    specific : Specific_e__Union do

    # Nested Type Specific_e__Union
    @[Extern(union: true)]
    record Specific_e__Union,
      null : UInt32,
      facial_features : FacialFeatures_e__Struct,
      fingerprint : Fingerprint_e__Struct,
      iris : Iris_e__Struct,
      voice : Voice_e__Struct do
      ...
      record FacialFeatures_e__Struct,
        ...
        frame_offset : Win32cr::Foundation::POINT,
        mandatory_orientation : UInt32,
        hardware_info : HardwareInfo_e__Struct do

        # Nested Type HardwareInfo_e__Struct
        @[Extern]
        record HardwareInfo_e__Struct,
      ...
      # Nested Type Fingerprint_e__Struct
      @[Extern]
      record Fingerprint_e__Struct,
        reserved : UInt32


      # Nested Type Voice_e__Struct
      @[Extern]
      record Voice_e__Struct,
        reserved : UInt32
  ...
  record WINBIO_EXTENDED_ENGINE_INFO,
    ...
    record Specific_e__Union,
      ...
      record Voice_e__Struct,
        capabilities : UInt32,
        enrollment_requirements : EnrollmentRequirements_e__Struct do

        # Nested Type EnrollmentRequirements_e__Struct
        @[Extern]
        record EnrollmentRequirements_e__Struct,
          null : UInt32
  ...
  record WINBIO_EXTENDED_ENROLLMENT_STATUS,
    ...
    record Specific_e__Union,
      ...
      record Iris_e__Struct,
        ...
        point3_d : Point3D_e__Struct,
        stop_capture_and_show_critical_feedback : Win32cr::Foundation::BOOL do

        # Nested Type Point3D_e__Struct
        @[Extern]
        record Point3D_e__Struct,
          x : Float64,
          y : Float64,
          z : Float64
  ...
  record WINBIO_ASYNC_RESULT,
    ...
    @[Extern(union: true)]
    record Parameters_e__Union,
      verify : Verify_e__Struct,
      identify : Identify_e__Struct,
      enroll_begin : EnrollBegin_e__Struct,
      enroll_capture : EnrollCapture_e__Struct,
      enroll_commit : EnrollCommit_e__Struct,
      enum_enrollments : EnumEnrollments_e__Struct,
      capture_sample : CaptureSample_e__Struct,
      delete_template : DeleteTemplate_e__Struct,
      get_property : GetProperty_e__Struct,
      set_property : SetProperty_e__Struct,
      get_event : GetEvent_e__Struct,
      control_unit : ControlUnit_e__Struct,
      enum_service_providers : EnumServiceProviders_e__Struct,
      enum_biometric_units : EnumBiometricUnits_e__Struct,
      enum_databases : EnumDatabases_e__Struct,
      verify_and_release_ticket : VerifyAndReleaseTicket_e__Struct,
      identify_and_release_ticket : IdentifyAndReleaseTicket_e__Struct,
      enroll_select : EnrollSelect_e__Struct,
      monitor_presence : MonitorPresence_e__Struct,
      get_protection_policy : GetProtectionPolicy_e__Struct,
      notify_unit_status_change : NotifyUnitStatusChange_e__Struct do

      # Nested Type GetProtectionPolicy_e__Struct
      @[Extern]
      record GetProtectionPolicy_e__Struct,
        identity : Win32cr::Devices::BiometricFramework::WINBIO_IDENTITY,
        policy : Win32cr::Devices::BiometricFramework::WINBIO_PROTECTION_POLICY


      # Nested Type EnrollSelect_e__Struct
      @[Extern]
      record EnrollSelect_e__Struct,
        selector_value : UInt64


      # Nested Type VerifyAndReleaseTicket_e__Struct
      @[Extern]
      record VerifyAndReleaseTicket_e__Struct,
        match : Win32cr::Foundation::BOOLEAN,
        reject_detail : UInt32,
        ticket : UInt64


      # Nested Type EnumBiometricUnits_e__Struct
      @[Extern]
      record EnumBiometricUnits_e__Struct,
        unit_count : LibC::UIntPtrT,
        unit_schema_array : Win32cr::Devices::BiometricFramework::WINBIO_UNIT_SCHEMA*


      # Nested Type ControlUnit_e__Struct
      @[Extern]
      record ControlUnit_e__Struct,
      ...
      # Nested Type SetProperty_e__Struct
      @[Extern]
      record SetProperty_e__Struct,
      ...
      # Nested Type DeleteTemplate_e__Struct
      @[Extern]
      record DeleteTemplate_e__Struct,
        identity : Win32cr::Devices::BiometricFramework::WINBIO_IDENTITY,
        sub_factor : UInt8


      # Nested Type EnumEnrollments_e__Struct
      @[Extern]
      record EnumEnrollments_e__Struct,
        identity : Win32cr::Devices::BiometricFramework::WINBIO_IDENTITY,
        sub_factor_count : LibC::UIntPtrT,
        sub_factor_array : UInt8*


      # Nested Type EnrollCapture_e__Struct
      @[Extern]
      record EnrollCapture_e__Struct,
        reject_detail : UInt32


      # Nested Type Identify_e__Struct
      @[Extern]
      record Identify_e__Struct,
        identity : Win32cr::Devices::BiometricFramework::WINBIO_IDENTITY,
        sub_factor : UInt8,
        reject_detail : UInt32


      # Nested Type MonitorPresence_e__Struct
      @[Extern]
      record MonitorPresence_e__Struct,
        change_type : UInt32,
        presence_count : LibC::UIntPtrT,
        presence_array : Win32cr::Devices::BiometricFramework::WINBIO_PRESENCE*


      # Nested Type EnumDatabases_e__Struct
      @[Extern]
      record EnumDatabases_e__Struct,
        storage_count : LibC::UIntPtrT,
        storage_schema_array : Win32cr::Devices::BiometricFramework::WINBIO_STORAGE_SCHEMA*


      # Nested Type GetEvent_e__Struct
      @[Extern]
      record GetEvent_e__Struct,
        event : Win32cr::Devices::BiometricFramework::WINBIO_EVENT


      # Nested Type CaptureSample_e__Struct
      @[Extern]
      record CaptureSample_e__Struct,
        sample : Win32cr::Devices::BiometricFramework::WINBIO_BIR*,
        sample_size : LibC::UIntPtrT,
        reject_detail : UInt32


      # Nested Type EnrollBegin_e__Struct
      @[Extern]
      record EnrollBegin_e__Struct,
        sub_factor : UInt8


      # Nested Type NotifyUnitStatusChange_e__Struct
      @[Extern]
      record NotifyUnitStatusChange_e__Struct,
        extended_status : Win32cr::Devices::BiometricFramework::WINBIO_EXTENDED_UNIT_STATUS


      # Nested Type EnumServiceProviders_e__Struct
      @[Extern]
      record EnumServiceProviders_e__Struct,
        bsp_count : LibC::UIntPtrT,
        bsp_schema_array : Win32cr::Devices::BiometricFramework::WINBIO_BSP_SCHEMA*


      # Nested Type EnrollCommit_e__Struct
      @[Extern]
      record EnrollCommit_e__Struct,
        identity : Win32cr::Devices::BiometricFramework::WINBIO_IDENTITY,
        is_new_template : Win32cr::Foundation::BOOLEAN


      # Nested Type GetProperty_e__Struct
      @[Extern]
      record GetProperty_e__Struct,
        property_type : UInt32,
        property_id : UInt32,
        identity : Win32cr::Devices::BiometricFramework::WINBIO_IDENTITY,
        sub_factor : UInt8,
      ...
      # Nested Type IdentifyAndReleaseTicket_e__Struct
      @[Extern]
      record IdentifyAndReleaseTicket_e__Struct,
        identity : Win32cr::Devices::BiometricFramework::WINBIO_IDENTITY,
        sub_factor : UInt8,
        reject_detail : UInt32,
        ticket : UInt64
      ...
      # Nested Type Verify_e__Struct
      @[Extern]
      record Verify_e__Struct,
        match : Win32cr::Foundation::BOOLEAN,
        reject_detail : UInt32
  ...
  @[Extern]
  record WINIBIO_SENSOR_CONTEXT
  @[Extern]
  record WINIBIO_ENGINE_CONTEXT
  @[Extern]
  record WINIBIO_STORAGE_CONTEXT
  @[Extern]
  ...
  record WINBIO_PIPELINE,
    ...
    sensor_context : Win32cr::Devices::BiometricFramework::WINIBIO_SENSOR_CONTEXT*,
    engine_context : Win32cr::Devices::BiometricFramework::WINIBIO_ENGINE_CONTEXT*,
    storage_context : Win32cr::Devices::BiometricFramework::WINIBIO_STORAGE_CONTEXT*,
