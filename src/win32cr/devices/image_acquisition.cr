...
module Win32cr::Devices::ImageAcquisition
  ...
  record WIA_PROPERTY_INFO,
    lAccessFlags : UInt32,
    vt : UInt16,
    valid_val : ValidVal_e__Union do

    # Nested Type ValidVal_e__Union
    @[Extern(union: true)]
    record ValidVal_e__Union,
      range : Range_e__Struct,
      range_float : RangeFloat_e__Struct,
      list : List_e__Struct,
      list_float : ListFloat_e__Struct,
      list_guid : ListGuid_e__Struct,
      list_b_str : ListBStr_e__Struct,
      flag : Flag_e__Struct,
      none : None_e__Struct do

      # Nested Type Flag_e__Struct
      @[Extern]
      record Flag_e__Struct,
        nom : Int32,
        valid_bits : Int32


      # Nested Type ListGuid_e__Struct
      @[Extern]
      record ListGuid_e__Struct,
        cNumList : Int32,
        nom : LibC::GUID,
        pList : LibC::GUID*


      # Nested Type List_e__Struct
      @[Extern]
      record List_e__Struct,
        cNumList : Int32,
        nom : Int32,
        pList : UInt8*
      ...
      # Nested Type None_e__Struct
      @[Extern]
      record None_e__Struct,
        dummy : Int32


      # Nested Type ListFloat_e__Struct
      @[Extern]
      record ListFloat_e__Struct,
        cNumList : Int32,
        nom : Float64,
        pList : UInt8*


      # Nested Type ListBStr_e__Struct
      @[Extern]
      record ListBStr_e__Struct,
        cNumList : Int32,
        nom : Win32cr::Foundation::BSTR,
        pList : Win32cr::Foundation::BSTR*


      # Nested Type RangeFloat_e__Struct
      @[Extern]
      record RangeFloat_e__Struct,
        min : Float64,
        nom : Float64,
        max : Float64,
        inc : Float64
  ...
  record WIAS_CHANGED_VALUE_INFO,
    ...
    vt : Int32,
    old : Old_e__Union,
    current : Current_e__Union do

    # Nested Type Old_e__Union
    @[Extern(union: true)]
    record Old_e__Union,
      lVal : Int32,
      fltVal : Float32,
    ...
    # Nested Type Current_e__Union
    @[Extern(union: true)]
    record Current_e__Union,
      lVal : Int32,
      fltVal : Float32,
      bstrVal : Win32cr::Foundation::BSTR,
      guidVal : LibC::GUID
