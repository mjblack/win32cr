...
module Win32cr::Devices::AllJoyn
  ...
  @[Extern]
  record Alljoyn_abouticon_handle
  @[Extern]
  ...
  @[Extern]
  record Alljoyn_abouticonobj_handle
  @[Extern]
  record Alljoyn_abouticonproxy_handle
  @[Extern]
  ...
  lib C
    ...
    fun alljoyn_abouticon_create : Win32cr::Devices::AllJoyn::Alljoyn_abouticon_handle*

    fun alljoyn_abouticon_destroy(icon : Win32cr::Devices::AllJoyn::Alljoyn_abouticon_handle*) : Void

    fun alljoyn_abouticon_getcontent(icon : Win32cr::Devices::AllJoyn::Alljoyn_abouticon_handle*, data : UInt8**, size : LibC::UIntPtrT*) : Void

    fun alljoyn_abouticon_setcontent(icon : Win32cr::Devices::AllJoyn::Alljoyn_abouticon_handle*, type__ : Win32cr::Foundation::PSTR, data : UInt8*, csize : LibC::UIntPtrT, ownsData : UInt8) : Win32cr::Devices::AllJoyn::QStatus

    fun alljoyn_abouticon_geturl(icon : Win32cr::Devices::AllJoyn::Alljoyn_abouticon_handle*, type__ : Int8**, url : Int8**) : Void

    fun alljoyn_abouticon_seturl(icon : Win32cr::Devices::AllJoyn::Alljoyn_abouticon_handle*, type__ : Win32cr::Foundation::PSTR, url : Win32cr::Foundation::PSTR) : Win32cr::Devices::AllJoyn::QStatus

    fun alljoyn_abouticon_clear(icon : Win32cr::Devices::AllJoyn::Alljoyn_abouticon_handle*) : Void

    fun alljoyn_abouticon_setcontent_frommsgarg(icon : Win32cr::Devices::AllJoyn::Alljoyn_abouticon_handle*, arg : Win32cr::Devices::AllJoyn::Alljoyn_msgarg) : Win32cr::Devices::AllJoyn::QStatus
    ...
    fun alljoyn_abouticonobj_create(bus : Win32cr::Devices::AllJoyn::Alljoyn_busattachment, icon : Win32cr::Devices::AllJoyn::Alljoyn_abouticon_handle*) : Win32cr::Devices::AllJoyn::Alljoyn_abouticonobj_handle*

    fun alljoyn_abouticonobj_destroy(icon : Win32cr::Devices::AllJoyn::Alljoyn_abouticonobj_handle*) : Void

    fun alljoyn_abouticonproxy_create(bus : Win32cr::Devices::AllJoyn::Alljoyn_busattachment, busName : Win32cr::Foundation::PSTR, sessionId : UInt32) : Win32cr::Devices::AllJoyn::Alljoyn_abouticonproxy_handle*

    fun alljoyn_abouticonproxy_destroy(proxy : Win32cr::Devices::AllJoyn::Alljoyn_abouticonproxy_handle*) : Void

    fun alljoyn_abouticonproxy_geticon(proxy : Win32cr::Devices::AllJoyn::Alljoyn_abouticonproxy_handle*, icon : Win32cr::Devices::AllJoyn::Alljoyn_abouticon_handle*) : Win32cr::Devices::AllJoyn::QStatus

    fun alljoyn_abouticonproxy_getversion(proxy : Win32cr::Devices::AllJoyn::Alljoyn_abouticonproxy_handle*, version : UInt16*) : Win32cr::Devices::AllJoyn::QStatus
