...
lib LibWin32
  ...
  C_AE_SRVSTATUS = 0_u32
  C_AE_SESSLOGON = 1_u32
  C_AE_SESSLOGOFF = 2_u32
  C_AE_SESSPWERR = 3_u32
  C_AE_CONNSTART = 4_u32
  C_AE_CONNSTOP = 5_u32
  C_AE_CONNREJ = 6_u32
  C_AE_RESACCESS = 7_u32
  C_AE_RESACCESSREJ = 8_u32
  C_AE_CLOSEFILE = 9_u32
  C_AE_SERVICESTAT = 11_u32
  C_AE_ACLMOD = 12_u32
  C_AE_UASMOD = 13_u32
  C_AE_NETLOGON = 14_u32
  C_AE_NETLOGOFF = 15_u32
  C_AE_NETLOGDENIED = 16_u32
  C_AE_ACCLIMITEXCD = 17_u32
  C_AE_RESACCESS2 = 18_u32
  C_AE_ACLMODFAIL = 19_u32
  C_AE_LOCKOUT = 20_u32
  C_AE_GENERIC_TYPE = 21_u32
  C_AE_SRVSTART = 0_u32
  C_AE_SRVPAUSED = 1_u32
  C_AE_SRVCONT = 2_u32
  C_AE_SRVSTOP = 3_u32
  C_AE_GUEST = 0_u32
  C_AE_USER = 1_u32
  ...
  C_AE_AUTODIS = 2_u32
  C_AE_UNSHARE = 2_u32
  C_AE_ADMINPRIVREQD = 2_u32
  C_AE_ADMINDIS = 3_u32
  C_AE_NOACCESSPERM = 3_u32
  C_AE_ACCRESTRICT = 4_u32
  C_AE_NORMAL_CLOSE = 0_u32
  C_AE_SES_CLOSE = 1_u32
  C_AE_ADMIN_CLOSE = 2_u32
  C_AE_LIM_UNKNOWN = 0_u32
  C_AE_LIM_LOGONHOURS = 1_u32
  C_AE_LIM_EXPIRED = 2_u32
  C_AE_LIM_INVAL_WKSTA = 3_u32
  C_AE_LIM_DISABLED = 4_u32
  C_AE_LIM_DELETED = 5_u32
  C_AE_MOD = 0_u32
  C_AE_DELETE = 1_u32
  C_AE_ADD = 2_u32
  C_AE_UAS_USER = 0_u32
  C_AE_UAS_GROUP = 1_u32
  C_AE_UAS_MODALS = 2_u32
  SVAUD_SERVICE = 1_u32
