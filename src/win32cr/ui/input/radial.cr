...
module Win32cr::UI::Input::Radial
  ...
  @[Extern]
  record IRadialControllerInteropVtable,
  ...
  @[Extern]
  record IRadialControllerInterop, lpVtbl : IRadialControllerInteropVtable* do
  ...
  @[Extern]
  record IRadialControllerConfigurationInteropVtable,
  ...
  @[Extern]
  record IRadialControllerConfigurationInterop, lpVtbl : IRadialControllerConfigurationInteropVtable* do
  ...
  @[Extern]
  record IRadialControllerIndependentInputSourceInteropVtable,
  ...
  @[Extern]
  record IRadialControllerIndependentInputSourceInterop, lpVtbl : IRadialControllerIndependentInputSourceInteropVtable* do
