...
module Win32cr::UI::Input::Touch
  ...
  @[Extern]
  record IManipulationEventsVtbl,
    query_interface : Proc(IManipulationEvents*, LibC::GUID*, Void**, Win32cr::Foundation::HRESULT),
    add_ref : Proc(IManipulationEvents*, UInt32),
    release : Proc(IManipulationEvents*, UInt32),
    manipulation_started : Proc(IManipulationEvents*, Float32, Float32, Win32cr::Foundation::HRESULT),
    manipulation_delta : Proc(IManipulationEvents*, Float32, Float32, Float32, Float32, Float32, Float32, Float32, Float32, Float32, Float32, Float32, Float32, Win32cr::Foundation::HRESULT),
    manipulation_completed : Proc(IManipulationEvents*, Float32, Float32, Float32, Float32, Float32, Float32, Float32, Win32cr::Foundation::HRESULT)


  @[Extern]
  #@[Com("4f62c8da-9c53-4b22-93df-927a862bbb03")]
  record IManipulationEvents, lpVtbl : IManipulationEventsVtbl* do
    ...
    def query_interface(this : IManipulationEvents*, riid : LibC::GUID*, ppvObject : Void**) : Win32cr::Foundation::HRESULT
      @lpVtbl.try &.value.query_interface.call(this, riid, ppvObject)
    end
    def add_ref(this : IManipulationEvents*) : UInt32
      @lpVtbl.try &.value.add_ref.call(this)
    end
    def release(this : IManipulationEvents*) : UInt32
      @lpVtbl.try &.value.release.call(this)
    end
    def manipulation_started(this : IManipulationEvents*, x : Float32, y : Float32) : Win32cr::Foundation::HRESULT
      @lpVtbl.try &.value.manipulation_started.call(this, x, y)
    end
    def manipulation_delta(this : IManipulationEvents*, x : Float32, y : Float32, translationDeltaX : Float32, translationDeltaY : Float32, scaleDelta : Float32, expansionDelta : Float32, rotationDelta : Float32, cumulativeTranslationX : Float32, cumulativeTranslationY : Float32, cumulativeScale : Float32, cumulativeExpansion : Float32, cumulativeRotation : Float32) : Win32cr::Foundation::HRESULT
    ...
    def manipulation_completed(this : IManipulationEvents*, x : Float32, y : Float32, cumulativeTranslationX : Float32, cumulativeTranslationY : Float32, cumulativeScale : Float32, cumulativeExpansion : Float32, cumulativeRotation : Float32) : Win32cr::Foundation::HRESULT
